...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mpmbr402del.jsp");
	}
	try
	{
		connect c = new connect();
   		Connection cnn = c.connectMethod();
		PreparedStatement pss=cnn.prepareStatement("delete from mpmbr402");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			String af20=request.getParameter("af20"+i);			
			String bf21=request.getParameter("bf21"+i);			
			String bf22=request.getParameter("bf22"+i);			
			
			pss=cnn.prepareStatement("insert into mpmbr402 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
			...
			pss.setString(21,af20);
			pss.setString(22,bf21);
			pss.setString(23,bf22);
