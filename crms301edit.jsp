...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="985">
<p align="center"><b><font color="#336699" size="2">CRMS 301 - RETURN ON RESTRUCTURED CREDIT PROFILE</font></b></p>     
    </td>
...
<body>
<form method="POST" action="crms301update.jsp">
<%
	PreparedStatement pst=cnn.prepareStatement("select * from crms301 where S_NO = ?");
...
<div align="center">
	...
	<%
		out.print("<td><input type=text name='bf21' size='30' value=\""+rs.getString(22)+"\"></td>");
	%>
