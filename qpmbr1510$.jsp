...
<br>
    ...
    <tr>
        <form action="qpmbr1510$.jsp" method="post" name="form11510">
	...
	<td align="center"><b><font color="#336699" size="2">TOTAL OTHER ASSETS</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QPMBR1510 where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QPMBR1510 where S_NO='T_99999'");
		while(rs.next())
		{
