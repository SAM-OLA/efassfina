...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir351");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 351</title>
...
<br>
    ...
    <tr>
        <form action="qdfir351$.jsp" method="post" name="form351">
 	...
 	<tr>
 	<form action="qdfir351Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR351.S_NO, QDFIR351.INSTITUTIONCODE, Banks.BankName, QDFIR351.ACCTNo, QDFIR351.AMOUNT, QDFIR351.REMARKS FROM Banks INNER JOIN QDFIR351 ON Banks.BankCode = QDFIR351.INSTITUTIONCODE where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir351 where S_NO='T_99999'");
		while(rs.next())
		{
