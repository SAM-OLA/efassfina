...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR412Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR412");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR412Data Values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 412</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 412 - RETURNS ON CONSUMERS COMPLAINT</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr412$.jsp" method="post" name="form412">
 	...
 	<tr>
 	<form action="mpmbr412Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">COMPLAIN REF NO</font></b></td>
	<td align="center"><b><font color="#336699" size="2">NAME OF PETITIONER</font></b></td>	
	<td align="center"><b><font color="#336699" size="2">ADDRESS/CONTACT DETAILS()phone no,email addr)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">SUBJECT</font></b></td>
	<td align="center"><b><font color="#336699" size="2">CATEGORY</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE RECEIVED</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE RESOLVED (RESOLVED)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">RESOLUTIONS EFFORT MADE (UNRESOLVED)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">MAJOR AREAS OF DISAGREEMENT (UNRESOLVED)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">AMOUNT CLAIMED(=N=)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">AMOUNT REFUNDED(=N=)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">AMOUNT CLAIMED($)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">AMOUNT REFUNDED($)</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR412Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR412Data where S_NO='T_99999'");
		while(rs.next())
		{
