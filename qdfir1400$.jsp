...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir1400");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 1400</title>
...
<br>
    ...
    <tr>
        <form action="qdfir1400$.jsp" method="post" name="form1400">
 	...
 	<tr>
 	<form action="qdfir1400Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">TOTAL NON PERFORMING OTHER ASSETS</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QDFIR1400 where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
    		...
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QDFIR1400 where S_NO='T_99999'");
		while(rs.next())
		{
