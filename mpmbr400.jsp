...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR400Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR400");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR400Data Values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 400</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 400 - RETURNS ON DISMISSED / TERMINATED STAFF</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr400$.jsp" method="post" name="form400">
 	...
 	<tr>
 	<form action="mpmbr400Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">NATIONALID CARD NUMBER</font></b></td>
	<td align="center"><b><font color="#336699" size="2">PERMANENT HIOME ADDRESS</font></b></td>
	<td align="center"><b><font color="#336699" size="2">NAME (BRANCH DETAILS)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">BRANCH CODE(BRANCH DETAILS)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">STATE CODE(BRANCH DETAILS)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DEPARTMENT(BRANCH DETAILS)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE TERMINATED / DISMISSED</font></b></td>
	<td align="center"><b><font color="#336699" size="2">REASONS FOR TERMINATION</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE REINSTATED</font></b></td>
	<td align="center"><b><font color="#336699" size="2">REASONS FOR REINSTATEMENT</font></b></td>
	<td align="center"><b><font color="#336699" size="2">ORGANIZATION (PWH)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">ADDRESS(PWH)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE FROM</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE TO</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR400Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR400Data where S_NO='T_99999'");
		while(rs.next())
		{
