...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per100del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per100");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per100 values(?,?,?,?,?,?,?)");		
		...
		pss.setString(4,String.valueOf(anom)); 	
		pss.setString(5,String.valueOf(acost)); 	
		pss.setString(6,String.valueOf(anum)); 	
