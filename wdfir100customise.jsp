...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("wdfir100del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from wdfir100");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into wdfir100 values(?,?,?,?,?,?,?,?,?,?)");		
