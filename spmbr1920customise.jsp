...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("spmbr1920del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from spmbr1920");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into spmbr1920 values(?,?,?,?,?,?,?,?,?,?,?)");		
