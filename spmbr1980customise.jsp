...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("spmbr1980del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from spmbr1980");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into spmbr1980 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
