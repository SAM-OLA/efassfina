...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per601del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per601");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per601 values(?,?,?,?,?,?)");		
