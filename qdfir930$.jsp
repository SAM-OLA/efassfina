...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir930");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 930</title>
...
<br>
    ...
    <tr>
        <form action="qdfir930$.jsp" method="post" name="form930">
 	...
 	<tr>
 	<form action="qdfir930Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">DATE CLOSED</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QDFIR930 where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir930 where S_NO='T_99999'");
		while(rs.next())
		{
