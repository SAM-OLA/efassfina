...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from per306");
		while(rs.next())
		{
			cn++;
		}
...
<title>CBN EFASS System - PER 306</title>
...
<br>
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
        <tr>
          ...
          <td width="1066">
          <p align="center"><b><font size="2">CAPTURE PENDING LITIGATION- PER 306</font></b></td>
          <td width="18">&nbsp;</td>
        </tr>
</table>
<br>
    ...
    <tr>
    <form action="per306$.jsp" method="post">
 	...
 	<tr>
 	<form action="per306customise.jsp" method="post">
	...
	<td>STATUS OF CASE</td>
	<td>AMOUNT INVOLVED IN CASES FOR THE BANK</td>
	<td>AMOUNT INVOLVED IN CASES AGAINST THE BANK</td>
	<td>EXPECTED LOSS</td>
	<td>REMARK(S)</td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from per306 where S_NO='"+i+"'");
			while(rs.next())
			{
				f1=rs.getString(2);
				f2=rs.getString(3);
    	...
    	String ss1="", ss2="", ss3="";
    	Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select AMOUNT_INVOLVED_IN_CASES_FOR_THE_BANK,AMOUNT_INVOLVED_IN_CASES_AGAINST_THE_BANK,EXPECTED_LOSS from per306 where S_NO='T_99999'");
		while(rs.next())
		{
