...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per404del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per404");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per404 values(?,?,?,?,?,?,?,?)");		
