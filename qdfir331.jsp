...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from QDFIR331Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from qdfir331");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into qdfir331Data Values(?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - QDFIR 331</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 331 - SCHEDULE OF BALANCES HELD WITH FOREIGN BANKS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qdfir331$.jsp" method="post" name="form331">
 	...
 	<tr>
 	<form action="qdfir331Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QDFIR331Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QDFIR331Data where S_NO='T_99999'");
		while(rs.next())
		{
