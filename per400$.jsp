...
<br>
	...
	<td>DOUBTFUL</td>
	<td>LOST</td>
	<td>GOVENRMENT PERFORMING</td>
	<td>GOVENRMENT NON-PERFORMING</td>
	<td>CUSTOMER TYPE</td>
    ...
    <%
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
				...
				out.println("<td ><input type=\"text\" name=\"f19" +i+ "\" value=\"0\"></td >");
				out.println("<td ><input type=\"text\" name=\"f20" +i+ "\" value=\"0\"></td >");
