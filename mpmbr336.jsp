...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR336Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR336");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR336Data Values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 336</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 336 - SCHEDULE OF OTHER LOANS AND RECEIVABLES</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr336$.jsp" method="post" name="form336">
 	...
 	<tr>
 	<form action="mpmbr336Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR336Data where S_NO='"+i+"'");
    		...
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR336Data where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(4).trim());
			ss2=String.valueOf(rs.getString(8).trim());
			ss3=String.valueOf(rs.getString(10).trim());
			ss4=String.valueOf(rs.getString(11).trim());
			ss5=String.valueOf(rs.getString(12).trim());
			...
			out.println("<td><input type=\"text\" name=\"total11\" value="+ss4+"></td >");
			out.println("<td><input type=\"text\" name=\"total12\" value="+ss5+"></td >");
