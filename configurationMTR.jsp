...
<title>Cube Group - MTR Configuaration File</title>
...
<p><b><font color="#336699" size="2">&nbsp;MTR CONFIGURATION SETTINGS</font></b></p>
<form name="frm" method="POST" action="storeConfigurationMTR.jsp">
