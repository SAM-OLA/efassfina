...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per101del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per101");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per101 values(?,?,?,?,?,?)");		
