...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR370Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR370");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR370Data Values(?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 370</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336899" size="2">MPMBR 370 - PLACEMENT FROM OTHER PMBs / FINANCIAL INSTITUTIONS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr370$.jsp" method="post" name="form370">
 	...
 	<tr>
 	<form action="mpmbr370Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336899" size="2">S_NO</font></b></td>
	<td align="center"><b><font color="#336899" size="2">INSTITUTION CODE</font></b></td>
	<td align="center"><b><font color="#336899" size="2">INSTITUTION NAME</font></b></td>	
	<td align="center"><b><font color="#336899" size="2">AMOUNT</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR370Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR370Data where S_NO='T_99999'");
		while(rs.next())
		{
