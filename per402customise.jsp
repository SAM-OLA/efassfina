...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per402del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per402");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per402 values(?,?,?,?,?,?,?,?,?)");		
