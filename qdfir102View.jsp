...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">BREAKDOWN OF OTHER ASSETS ITEMS - QDFIR 102</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
...
try
{
	pst=cn.prepareStatement("select * from qdfir102Data");
	rs=pst.executeQuery();
	while(rs.next())
	{
%>
...
{
	out.println("Error getting qdfir102 view data: "+e.toString());
}
%>
  </table>
