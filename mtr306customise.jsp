...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mtr306del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from mtr306");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mtr306 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
			...
			anom1+=Double.parseDouble(f5);
			anom2+=Double.parseDouble(f7);
			anom3+=Double.parseDouble(f11);
			anom4+=Double.parseDouble(f12);
			anom5+=Double.parseDouble(f13);
			anom6+=Double.parseDouble(f14);
			anom7+=Double.parseDouble(f15);
		...
		pss.setString(5,String.valueOf(request.getParameter("total5"))); 
 		pss.setString(6,String.valueOf(anom1)); 
 		pss.setString(7,String.valueOf(request.getParameter("total7"))); 
 		pss.setString(8,String.valueOf(anom2)); 
 		...
 		pss.setString(12,String.valueOf(anom3)); 
 		pss.setString(13,String.valueOf(anom4)); 
 		pss.setString(14,String.valueOf(anom5)); 
 		pss.setString(15,String.valueOf(anom6)); 
 		pss.setString(16,String.valueOf(anom7)); 
		pss.executeUpdate();
		cnn.close();
		%>
