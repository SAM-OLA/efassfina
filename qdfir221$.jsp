...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir221");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 221</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 221 - SCHEDULE OF BALANCES DUE TO OTHER BANKS IN NIGERIA</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qdfir221$.jsp" method="post" name="form221">
 	...
 	<tr>
 	<form action="qdfir221Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR221.S_NO, QDFIR221.INSTITUTIONCODE, Banks.BankName, QDFIR221.AMOUNT FROM Banks INNER JOIN QDFIR221 ON Banks.BankCode = QDFIR221.INSTITUTIONCODE where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir221 where S_NO='T_99999'");
		while(rs.next())
		{
