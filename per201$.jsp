...
<br>
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
        <tr>
          ...
          <td width="1066">
          <p align="center"><b><font size="2">CAPTURE LIST OF BANK’S PRINCIPAL OFFICERS- PER 201</font></b></td>
          <td width="18">&nbsp;</td>
        </tr>
</table>
<br>
    ...
    <tr>
    <form action="per201$.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from per201 where S_NO='"+i+"'");
			while(rs.next())
			{
				f1=rs.getString(2);
				f2=rs.getString(3);
    			...
    			out.println("<td ><input type=\"text\" name=\"f7" +i+ "\" onBlur=\"return validate(this)\" value=\""+f7+"\"></td >");
				out.println("<td ><input type=\"text\" name=\"f8" +i+ "\" onBlur=\"return validate(this)\" value=\""+f8+"\"></td >");
				out.println("</tr> ");
			}
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
    		...
    		out.println("<td ><input type=\"text\" name=\"f1" +i+ "\"></td >");	
    			...
    			out.println("<td ><input type=\"text\" name=\"f7" +i+ "\" onBlur=\"return validate(this)\" value=\"0\"></td >");
				out.println("<td ><input type=\"text\" name=\"f8" +i+ "\" onBlur=\"return validate(this)\" value=\"0\"></td >");
				out.println("</tr> ");
    	}
    	String ss1="", ss2="";
    	Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select SALARY,ALLOWANCES from PER201 where S_NO='T_99999'");
		while(rs.next())
		{
