...
<br>
    ...
    <%
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
				...
				out.println("<td ><input type=\"checkbox\" name=\"chec" +i+ "\" onClick=\"if (this.checked) {this.form.chec"+i+".value='1'} else {this.form.chec"+i+".value='0'}\"</td>");
    				out.println("<td ><input type=\"text\" readonly name=\"count" +i+ "\" value="+i+ "></td >");
    				out.println("<td ><input type=\"text\" size=55 name=\"f1" +i+ "\" value=\"0\"></td >");	
    	...
    	String ss1="";
    	Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from per302 where S_NO='T_99999'");
		while(rs.next())
		{
		...
		out.println("<td ><input type=\"text\" size=55 name=\"total2\"></td >");
