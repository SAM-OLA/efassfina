...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR402Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR402");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR402Data Values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                  ...
                  pstInsert.setString(21, rs.getString(21));
                  pstInsert.setString(22, rs.getString(22));
                  pstInsert.setString(23, rs.getString(23));
...
<title>Cube CBN EFASS System - MPMBR 402</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 402 - RETURNS ON FRAUD AND FORGERIES ARMED ROBBERY (BANK STAFF)</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr402$.jsp" method="post" name="form402">
 	...
 	<tr>
 	<form action="mpmbr402Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">SURNAME</font></b></td>
	...
	<td align="center"><b><font color="#336699" size="2">DESIGNATION</font></b></td>
	<td align="center"><b><font color="#336699" size="2">SEX</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE OF BIRTH</font></b></td>
	<td align="center"><b><font color="#336699" size="2">NATIONALITY</font></b></td>
	<td align="center"><b><font color="#336699" size="2">STATE OF ORIGIN</font></b></td>
	<td align="center"><b><font color="#336699" size="2">PASSPORT NUMBER</font></b></td>
	<td align="center"><b><font color="#336699" size="2">NATIONAL ID CARD NUMBER</font></b></td>
	<td align="center"><b><font color="#336699" size="2">BRANCH NAME</font></b></td>
	<td align="center"><b><font color="#336699" size="2">BRANCH CODE</font></b></td>
	<td align="center"><b><font color="#336699" size="2">STATE CODE</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DEPARTMENT</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE OF FRAUD</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE DISCOVERED</font></b></td>
	<td align="center"><b><font color="#336699" size="2">AMOUNT INVOLVED</font></b></td>
	<td align="center"><b><font color="#336699" size="2">STATUS: (successful, partially successful and Unsucceessful)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">AMOUNT RECOVERED</font></b></td>
	<td align="center"><b><font color="#336699" size="2">ACTUAL LOSS</font></b></td>
	<td align="center"><b><font color="#336699" size="2">TYPE</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE</font></b></td>
	
	</tr>
    <%
    	try
		{
    	String f1="", f2="", f3="", f4="", f5="", f6="", f7="", f8="", f9="", f10="", af11="", af12="", af13="", af14="", af15="", af16="", af17="", af18="", af19="", af20="", bf21="", bf22="";    	
    	int ccn=cn-1;
    	for(int i=1;i<cn;i++) 
    	{
    			Statement st2=cnn.createStatement();
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR402Data where S_NO='"+i+"'");
			...
			while(rs.next())
			{
				...
				af20=rs.getString(21);
				bf21=rs.getString(22);
				bf22=rs.getString(23);
				...
				out.println("<td ><input type=\"text\" name=\"af20" +i+ "\" value=\""+af20+"\"></td >");	
				out.println("<td ><input type=\"text\" name=\"bf21" +i+ "\" value=\""+bf21+"\"></td >");	
				out.println("<td ><input type=\"text\" name=\"bf22" +i+ "\" value=\""+bf22+"\"></td >");	
				out.println("</tr> ");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR402Data where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(20).trim());
