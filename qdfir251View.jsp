...
<form name"frm" method="POST" action="qdfir251Customise.jsp">
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir251");
		rs=pst.executeQuery();
...
<%
	...
	{
		out.println("QDFIR 251 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
