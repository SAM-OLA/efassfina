...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR378Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR378");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR378Data Values(?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 378</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336899" size="2">MPMBR 378 - SCHEDULE OF BALANCES DUE TO OTHERS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr378$.jsp" method="post" name="form378">
 	...
 	<tr>
 	<form action="mpmbr378Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR378Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR378Data where S_NO='T_99999'");
		while(rs.next())
		{
