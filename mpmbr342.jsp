...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR342Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR342");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR342Data Values(?,?,?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 342</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 342 - SCHEDULE OF IMPAIRED LOANS AND RECEIVABLES / LEASES</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr342$.jsp" method="post" name="form342">
 	...
 	<tr>
 	<form action="mpmbr342Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">TOTAL IMPAIRED CREDITS</font></b></td>
	<td align="center"><b><font color="#336699" size="2">IMPAIRMENT</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR342Data where S_NO='"+i+"'");
    		...
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR342Data where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(4).trim());
			ss2=String.valueOf(rs.getString(5).trim());
			ss3=String.valueOf(rs.getString(6).trim());
			ss4=String.valueOf(rs.getString(7).trim());
			ss5=String.valueOf(rs.getString(8).trim());
