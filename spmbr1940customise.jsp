...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("spmbr1940del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from spmbr1940");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into spmbr1940 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
