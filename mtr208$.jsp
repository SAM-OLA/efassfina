...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MTR 208 - ANALYSIS OF FOREIGN EXCHANGE UTILIZATION ON FORM 'M' (BILLS FOR COLLECTION - VALID FOR FOREIGN EXCHANGE) SOURCED FROM CBN SALES</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mtr208$.jsp" method="post" name="form208">
...
<td></td>
<td></td>
<td colspan=2 align=CENTER><b>------------AMOUNT US $-------------</b></td>
<td></td>
	...
	<td align="center" valign="bottom"><b><font color="#336699" size="1">EXCHANGE RATE AT WHICH FUND WAS PURCHASED FROM CBN</font></b></td>
