...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("sdfir1950del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from sdfir1950");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into sdfir1950 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
