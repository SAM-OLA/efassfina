...
<form name"frm" method="POST" action="qdfir262Customise.jsp">
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir262");
		rs=pst.executeQuery();
...
<%
	...
	{
		out.println("QDFIR 262 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
