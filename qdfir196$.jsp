...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir196");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 196</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 196 - SCHEDULE OF MONEY AT CALL HELD FOR INTERNAL BANKS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qdfir196$.jsp" method="post" name="form196">
 	...
 	<tr>
 	<form action="qdfir196Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR196.S_NO, QDFIR196.INSTITUTIONCODE, Banks.BankName, QDFIR196.ACCTNo, QDFIR196.AMOUNT FROM Banks INNER JOIN QDFIR196 ON Banks.BankCode = QDFIR196.INSTITUTIONCODE where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir196 where S_NO='T_99999'");
		while(rs.next())
		{
