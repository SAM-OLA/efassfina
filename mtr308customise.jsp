...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mtr308del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from mtr308");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mtr308 values(?,?,?,?,?,?,?,?)");		
