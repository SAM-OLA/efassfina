...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1072">
<p align="center"><b><font color="#336699" size="2">SCHEDULE OF OTHER LIABILITIES - QDFIR - 301</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
...
<%
	try
	{
		PreparedStatement pst=cn.prepareStatement("select * from qdfir301Data");
