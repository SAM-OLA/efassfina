...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mpmbr351del.jsp");
	}
	try
	{
		connect c = new connect();
   		Connection cnn = c.connectMethod();
		PreparedStatement pss=cnn.prepareStatement("delete from mpmbr351Data where ITEMCODE ='"+code+"'");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mpmbr351Data values(?,?,?,?,?)");		
