...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR346Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR346");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR346Data Values(?,?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 346</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 346 - SCHEDULE OF CARRYING AMOUNT OF QUOTED/UNQUOTED EQUITY INVESTMENTS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr346$.jsp" method="post" name="form346">
 	...
 	<tr>
 	<form action="mpmbr346Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">COST (=N=)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">QUOTED IMPAIRMENT (=N=)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">UNQUOTED IMPAIRMENT</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR346Data where S_NO='"+i+"'");
    		...
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR346Data where S_NO='T_99999'");
		while(rs.next())
		{
