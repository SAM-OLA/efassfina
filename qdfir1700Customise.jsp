...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("qdfir1700del.jsp");
	}
	try
	{
		connect c = new connect();
   		Connection cnn = c.connectMethod();
		PreparedStatement pss=cnn.prepareStatement("delete from qdfir1700");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into qdfir1700 values(?,?,?,?,?,?,?,?,?,?,?)");		
		...
		pss.setString(11,String.valueOf(anom3));
		pss.executeUpdate();
		cnn.close();
		%>
		<SCRIPT Language = "JavaScript">
		    alert("Data Successful saved");
		    window.location = 'qdfir1700.jsp';
	      </SCRIPT>
		<%
