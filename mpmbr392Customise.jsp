...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mpmbr392del.jsp");
	}
	try
	{
		connect c = new connect();
   		Connection cnn = c.connectMethod();
		PreparedStatement pss=cnn.prepareStatement("delete from mpmbr392");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mpmbr392 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
		...
		pss.setString(17,String.valueOf(anom1));
