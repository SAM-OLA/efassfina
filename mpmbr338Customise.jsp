...
<%
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from mpmbr338");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mpmbr338 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
			...
			anom2+=Double.parseDouble(f10);
			anom3+=Double.parseDouble(af11);
			anom4+=Double.parseDouble(af12);
			anom5+=Double.parseDouble(af13);
			anom6+=Double.parseDouble(af14);
			anom7+=Double.parseDouble(af15);
			anom8+=Double.parseDouble(af16);
			anom9+=Double.parseDouble(af17);
			anom10+=Double.parseDouble(af18);
			anom11+=Double.parseDouble(af19);
			pss.executeUpdate();
		...
		pss.setString(11,String.valueOf(ls_format1.format(anom2)));
		pss.setString(12,String.valueOf(ls_format1.format(anom3)));
		pss.setString(13,String.valueOf(ls_format1.format(anom4)));
		pss.setString(14,String.valueOf(ls_format1.format(anom5)));
		pss.setString(15,String.valueOf(ls_format1.format(anom6)));
		pss.setString(16,String.valueOf(ls_format1.format(anom7)));
		pss.setString(17,String.valueOf(ls_format1.format(anom8)));
		pss.setString(18,String.valueOf(ls_format1.format(anom9)));
		pss.setString(19,String.valueOf(ls_format1.format(anom10)));
		pss.setString(20,String.valueOf(ls_format1.format(anom11)));
		pss.executeUpdate();
		cnn.close();
		%>
		<SCRIPT Language = "JavaScript">
		    alert("Data Successful saved");
		    window.location = 'mpmbr338.jsp';
	      </SCRIPT>
		<%
