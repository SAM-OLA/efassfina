...
<title>Bank Onsite Surveillance Bank Exam Pre Exam Requirements OnRequest - Select  Report(s) to generate</title>
...
%>
<br>
          <table border="1" cellpadding="3" style="border-collapse: collapse" width="629" >

      <form method="POST" action="generate_per2.jsp">
