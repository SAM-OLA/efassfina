...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR408Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR408");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR408Data Values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 408</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 408 - RETURNS ON TOTAL LOANS AND ADVANCES GRANTED TO / OUTSTANDING BONDS AGAINST LOCAL GOVERNMENT</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr408$.jsp" method="post" name="form408">
 	...
 	<tr>
 	<form action="mpmbr408Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">STATE/STATE CODE</font></b></td>
	<td align="center"><b><font color="#336699" size="2">LOCAL GOVERNMENTS/LG CODE</font></b></td>	
	<td align="center"><b><font color="#336699" size="2">UP TO 2 YRS(TERM LOAN)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">2-5 YRS(TERM LOAN)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">5-10 YRS(TERM LOAN)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">OVER 10YRS(TERM LOAN)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">OVERDRAFT</font></b></td>
	<td align="center"><b><font color="#336699" size="2">OTHERS</font></b></td>
	<td align="center"><b><font color="#336699" size="2">TOTAL</font></b></td>
	<td align="center"><b><font color="#336699" size="2">UP TO 2 YRS(BONDS)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">2-5 YRS(BONDS)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">5-10 YRS(BONDS)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">OVER 10YRS(BONDS)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">TOTAL</font></b></td>
    ...
    <%
    	try
		{
    	String f1="", f2="", f3="", f4="", f5="", f6="", f7="", f8="", f9="", f10="", af11="", af12="", af13="", af14="";    	
    	int ccn=cn-1;
    	for(int i=1;i<cn;i++) 
    	{
    			Statement st2=cnn.createStatement();
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR408Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR408Data where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(15).trim());
