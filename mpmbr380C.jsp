...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR380CData");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR380C");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR380CData Values(?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 380.3</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 380.3 - SCHEDULE OF DERIVATIVE FINANCIAL LIABILITIES - Derivatives used as fair value hedge(by types)</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr380C$.jsp" method="post" name="form380C">
 	...
 	<tr>
 	<form action="mpmbr380CCustomise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">DERIVATIVE FINANCIAL LIABILITIES</font></b></td>
	<td align="center"><b><font color="#336699" size="2">NOTIONAL AMOUNT<br>(=N=)</font></b></td>	
	<td align="center"><b><font color="#336699" size="2">CARRYING VALUE<br>(=N=)</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR380CData where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR380CData where S_NO='T_99999'");
		while(rs.next())
		{
