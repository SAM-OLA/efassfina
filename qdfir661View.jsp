...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 661 - SCHEDULE OF PLACEMENT FROM BANKS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
...
<form name"frm" method="POST" action="qdfir661Customise.jsp">
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir661");
		rs=pst.executeQuery();
...
<%
	...
	{
		out.println("QDFIR 661 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
