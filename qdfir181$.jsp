...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir181");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 181</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 181 - SCHEDULE OF DEPOSITS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qdfir181$.jsp" method="post" name="form181">
 	...
 	<tr>
 	<form action="qdfir181Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR181.S_NO, QDFIR181.INSTITUTIONCODE, Banks.BankName, QDFIR181.AMOUNT FROM Banks INNER JOIN QDFIR181 ON Banks.BankCode = QDFIR181.INSTITUTIONCODE where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir181 where S_NO='T_99999'");
		while(rs.next())
		{
