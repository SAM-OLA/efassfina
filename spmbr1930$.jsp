...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from spmbr1930");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - SPMBR 1930</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1074">
<p align="center"><b><font color="#336699" size="2">SEMI-ANNUAL RETURN ON BANK'S DIRECTORS- SPMBR 1930</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
    <form action="spmbr1930$.jsp" method="post">
 	...
 	<tr>
 	<form action="spmbr1930customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from spmbr1930 where S_NO='"+i+"'");
			Statement stspmbr1930EXEC_NONEXEC =cnn.createStatement();
			ResultSet rsspmbr1930EXEC_NONEXEC = stspmbr1930EXEC_NONEXEC.executeQuery("select * from spmbr1930EXEC_NONEXEC");
			Statement stspmbr1930HOME_STATE_CODE =cnn.createStatement();
			ResultSet rsspmbr1930HOME_STATE_CODE = stspmbr1930HOME_STATE_CODE.executeQuery("select * from spmbr1930HOME_STATE_CODE");
			Statement stspmbr1930MODE_OF_APPOINTMENT =cnn.createStatement();
			ResultSet rsspmbr1930MODE_OF_APPOINTMENT = stspmbr1930MODE_OF_APPOINTMENT.executeQuery("select * from spmbr1930MODE_OF_APPOINTMENT");
			Statement stspmbr1930STATE_CODE =cnn.createStatement();
			ResultSet rsspmbr1930STATE_CODE = stspmbr1930STATE_CODE.executeQuery("select * from spmbr1930STATE_CODE");
			...
			while(rs.next())
			{
				...
				while(rsspmbr1930STATE_CODE.next())
					{
						String str1 = rsspmbr1930STATE_CODE.getString(1);
						String str2 = rsspmbr1930STATE_CODE.getString(2);
        					if(f6.equals(str1))
        					{
				...
				out.println("<option value=''>------Select------</option>");
				while(rsspmbr1930HOME_STATE_CODE.next())
					{
						String str1 = rsspmbr1930HOME_STATE_CODE.getString(1);
						String str2 = rsspmbr1930HOME_STATE_CODE.getString(2);
        					if(f11.equals(str1))
        					{
							out.println("<option selected value="+str1+">"+str2+"</option>");
        					}
				...
				out.println("<option value=''>------Select------</option>");
				while(rsspmbr1930MODE_OF_APPOINTMENT.next())
					{
						String str1 = rsspmbr1930MODE_OF_APPOINTMENT.getString(1);
						String str2 = rsspmbr1930MODE_OF_APPOINTMENT.getString(2);
        					if(f13.equals(str1))
        					{
							out.println("<option selected value="+str1+">"+str2+"</option>");
        					}
				...
				out.println("<option value=''>------Select------</option>");
				while(rsspmbr1930EXEC_NONEXEC.next())
					{
						String str1 = rsspmbr1930EXEC_NONEXEC.getString(1);
						String str2 = rsspmbr1930EXEC_NONEXEC.getString(2);
        					if(f14.equals(str1))
        					{
							out.println("<option selected value="+str1+">"+str2+"</option>");
        					}
