...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mtr207del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from mtr207");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mtr207 values(?,?,?,?,?,?,?,?)");		
