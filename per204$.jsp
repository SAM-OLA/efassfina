...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from per204");
		while(rs.next())
		{
			cn++;
		}
...
<title>CBN EFASS System - PER 204</title>
...
<br>
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
        <tr>
          ...
          <td width="1066">
          <p align="center"><b><font size="2">CAPTURE BANK TRAINING PROGRAMME- PER 204</font></b></td>
          <td width="18">&nbsp;</td>
        </tr>
</table>
<br>
    ...
    <tr>
    <form action="per204$.jsp" method="post">
 	...
 	<tr>
 	<form action="per204customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from per204 where S_NO='"+i+"'");
			while(rs.next())
			{
				f1=rs.getString(2);
				f2=rs.getString(3);
