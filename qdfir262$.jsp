...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir262");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 262</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 262 - BREAKDOWN OF OTHER FIXED ASSETS ITEMS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qdfir262$.jsp" method="post" name="form262">
 	...
 	<tr>
 	<form action="qdfir262Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR262.S_NO, QDFIR262.ITEMDESCRIPTION, QDFIR262.AMOUNT FROM QDFIR262 where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir262 where S_NO='T_99999'");
		while(rs.next())
		{
