...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per503del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per503");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per503 values(?,?,?,?,?,?,?,?,?)");		
