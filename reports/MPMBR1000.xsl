...
<xsl:variable name="filename">D:/Program Files/Apache Software Foundation/Tomcat 5.0/webapps/cbnpmbifrs/images/LogoNexim.JPG</xsl:variable>
...
<fo:table-column column-width="357.0pt"/>
<fo:table-column column-width="108.0pt"/>
<fo:table-column column-width="109.0pt"/>
<fo:table-header>
...
<fo:table-cell border-left-style="solid" border-left-width="0.99991pt" border-left-color="#000000" border-top-style="solid" border-top-width="0.99991pt" border-top-color="#000000" number-rows-spanned="2" display-align="center">
...
<xsl:text>CURRENT MONTH</xsl:text></fo:block>
</fo:table-cell>
<fo:table-cell border-left-style="solid" border-left-width="1.0pt" border-left-color="#000000" border-right-style="solid" border-right-width="1.0pt" border-right-color="#000000" border-top-style="solid" border-top-width="1.0pt" border-top-color="#000000" number-rows-spanned="2" display-align="center">
<fo:block line-height="19.2pt" white-space-collapse="false"  linefeed-treatment="preserve"  text-align="end" color="#000000" font-family="Arial" font-size="16.0pt">
<xsl:text>YEAR TO DATE</xsl:text></fo:block>
</fo:table-cell>
</fo:table-row>
...
<fo:table-row>
<fo:table-cell border-top-style="solid" border-top-width="1.0pt" border-top-color="#000000" number-columns-spanned="4" display-align="before">
...
<xsl:value-of disable-output-escaping="no" select="ITEM_CURRENTMONTH"/>
</fo:block>
</fo:table-cell>
...
<fo:block line-height="14.5pt" white-space-collapse="false"  linefeed-treatment="preserve"  text-align="end" color="#000000" font-family="Arial" font-size="12.0pt">
<xsl:value-of disable-output-escaping="no" select="ITEM_YEARTODATE"/>
</fo:block>
</fo:table-cell>
</fo:table-row>
