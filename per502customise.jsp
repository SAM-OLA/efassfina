...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per502del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per502");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per502 values(?,?,?,?,?,?,?)");		
