...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("sdfir1940del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from sdfir1940");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into sdfir1940 values(?,?,?,?,?,?,?,?,?,?,?,?,?)");		
