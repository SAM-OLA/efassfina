...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir1300");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 1300</title>
...
<br>
    ...
    <tr>
        <form action="qdfir1300$.jsp" method="post" name="form1300">
 	...
 	<tr>
 	<form action="qdfir1300Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">TOTAL CREDIT</font></b></td>
	<td align="center"><b><font color="#336699" size="2">PRINCIPAL PAYMENT DUE AND UNPAID</font></b></td>
	<td align="center"><b><font color="#336699" size="2">ACCRUED INTEREST UNPAID</font></b></td>
	<td align="center"><b><font color="#336699" size="2">TOTAL NON PERFORMING CREDITS</font></b></td>
	<td align="center"><b><font color="#336699" size="2">STANDARD</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DOUBTFUL</font></b></td>
	<td align="center"><b><font color="#336699" size="2">LOSS</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DFI'S PROVISION</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QDFIR1300 where S_NO='"+i+"'");
    		...
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QDFIR1300 where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(4));
			ss2=String.valueOf(rs.getString(5));
			ss3=String.valueOf(rs.getString(6));
			ss4=String.valueOf(rs.getString(7));
			ss5=String.valueOf(rs.getString(8));
			ss6=String.valueOf(rs.getString(9));
			ss7=String.valueOf(rs.getString(10));
			ss8=String.valueOf(rs.getString(11));
		...
		out.println("<td><input type=\"text\" name=\"total7\" value="+ss4+"></td >");
		out.println("<td><input type=\"text\" name=\"total8\" value="+ss5+"></td >");
		out.println("<td><input type=\"text\" name=\"total9\" value="+ss6+"></td >");
		out.println("<td><input type=\"text\" name=\"total10\" value="+ss7+"></td >");
		out.println("<td><input type=\"text\" name=\"total11\" value="+ss8+"></td >");
