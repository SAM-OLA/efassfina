...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <a href='dtrtoc.jsp'>MTR TOC</a> </font></b> </td>
    <td width="1063">
...
<br>
    ...
    <tr>
        <form action="dtr217$.jsp" method="post" name="form217">
 	...
 	<tr>
 	<form action="dtr217customise.jsp" method="post">
 	<td valign="bottom">
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from dtr217 where S_NO='"+i+"'");
