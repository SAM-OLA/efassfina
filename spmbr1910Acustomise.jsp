...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("spmbr1910Adel.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from spmbr1910A");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into spmbr1910A values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
...
%>
		  <SCRIPT Language = "JavaScript">
		    ...
		    window.location = 'spmbr1910A.jsp';
    		</SCRIPT>
<%
	}
	catch(Exception e)
