...
Note: Expected Total: <%=rs3.getString(1)%> 
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR961.S_NO, QDFIR961.ITEMDESCRIPTION, QDFIR961.AMOUNT FROM QDFIR961 where S_NO='"+i+"'");
			...
			while(rs.next())
			{
				...
				out.println("<td ><input type=\"text\" readonly name=\"count" +i+ "\" value="+i+ "></td >");
	    			out.println("<td ><input type=\"text\" name=\"f1" +i+ "\" value=\""+f1+"\" size=\"62\" ></td >");	
