...
<!--mstheme--><link rel="stylesheet" type="text/css" href="_themes/poetic/poet1111.css"><meta name="Microsoft Theme" content="poetic 1111">
</head>
...
<br>
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			ResultSet rsSectorCodes = stSectorCodes.executeQuery("select * from HSCodes order by Code");
