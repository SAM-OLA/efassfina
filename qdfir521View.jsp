...
<form name"frm" method="POST" action="qdfir521Customise.jsp">
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir521");
		rs=pst.executeQuery();
...
<%
	...
	{
		out.println("QDFIR 521 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
