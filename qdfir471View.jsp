...
<form name"frm" method="POST" action="qdfir471Customise.jsp">
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir471");
		rs=pst.executeQuery();
...
<%
	...
	{
		out.println("QDFIR 471 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
