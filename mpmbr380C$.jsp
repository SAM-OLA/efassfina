...
<br>
	...
	<td align="center"><b><font color="#336699" size="2">NOTIONAL AMOUNT(=N=)</font></b></td>	
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR380C where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR380C where S_NO='T_99999'");
		while(rs.next())
		{
