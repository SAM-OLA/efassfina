...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 671 - SCHEDULE OF PLACEMENT FROM BANKS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
...
<form name"frm" method="POST" action="qdfir671Customise.jsp">
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" id="AutoNumber1" width="30%">
      ...
      <th><b><font color="#336699" size="2">INST. CODE</font></b></th>
      <th><b><font color="#336699" size="2">INSTITUTION NAME</font></b></th>
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir671");
		rs=pst.executeQuery();
...
<%
	...
	{
		out.println("QDFIR 671 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
