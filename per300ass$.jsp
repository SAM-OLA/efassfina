...
<br>
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
        <tr>
          ...
          <td width="1066">
          <p align="center"><b><font size="2">CAPTURE BRANCH - BY - BRANCH TRIAL BALANCE (ASSETS) - PER 300</font></b></td>
          <td width="18">&nbsp;</td>
        </tr>
</table>
<br>
    ...
    <%
   	...
   	String f1="", f2="", f3="", f4="", f5="", f6="", f7="", f8="", f9="";
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rsCategory = stCategory.executeQuery("select * from PER300ASSETS_BANK_CATEGORISATION");
