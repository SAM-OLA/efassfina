...
<br>
    ...
    <tr>
        <form action="qpmbr1540$.jsp" method="post" name="form11540">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QPMBR1540 where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QPMBR1540 where S_NO='T_99999'");
		while(rs.next())
		{
