...
<form name"frm" method="POST" action="qdfir221Customise.jsp">
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir221");
		rs=pst.executeQuery();
...
%>
			<tr bgcolor="blue">
				...
				<td><input type="text" name="institutionsname<%=cnt%>" size="50" value="<%=rs.getString(2)%>"></td>
				<td><input type="text" name="institutioncode<%=cnt%>" size="50" value="<%=rs.getString(3)%>"></td>
...
<%
	...
	{
		out.println("QDFIR 221 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
