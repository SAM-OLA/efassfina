...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 374 - SCHEDULE OF BALANCES DUE TO OTHER PMBs / FINANCIAL INSTITUTIONS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR374 where S_NO='"+i+"'");
			...
			while(rs.next())
			{
				...
				out.println("<td ><input type=\"text\" readonly name=\"f2" +i+ "\" size=\"60\" value=\""+f2+"\"></td >");	
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
				...
				while(rsBanks.next())
        			...
        			out.println("</select></td>");
				out.println("<td ><input type=\"text\" readonly name=\"f2" +i+ "\" size=\"60\"  value=\"0\"></td >");	
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR374 where S_NO='T_99999'");
		while(rs.next())
		{
