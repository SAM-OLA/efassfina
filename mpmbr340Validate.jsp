...
<%
	...
	{
		out.println("mpmbr340Validate Error: "+e.toString());
	}
	...
	pst=cn.prepareStatement("select [STATE_GOVTS],[LOCAL_GOVTS],[TOTAL_CREDIT] from mpmbr340Data where code='41500'");
