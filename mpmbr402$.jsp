...
<br>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR402 where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
				...
				out.println("<td ><input type=\"text\" name=\"af19" +i+ "\" value=\"0\"></td >");		
				out.println("<td ><input type=\"text\" name=\"af20" +i+ "\" value=\"0\"></td >");	
				out.println("<td ><input type=\"text\" name=\"bf21" +i+ "\" value=\"0\"></td >");	
				out.println("<td ><input type=\"text\" name=\"bf22" +i+ "\" value=\"0\"></td >");
				out.println("</tr> ");

    	}
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR402 where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(23).trim());
		}
	    	out.println("<tr >");	
