...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir601");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 601</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 601 - SCHEDULE OF UNDRAWN COMMITMENTS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
...
<%
		...
		ResultSet rs3=st3.executeQuery("select [Memo Undrawn commit] from qdfir600Data where code='40600'");
		rs3.next();
%>
Note: Expected Total for [Undrawn commit]: <%=rs3.getString(1)%> 
</pre>    
    <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
    <tr>
        <form action="qdfir601$.jsp" method="post" name="form601">
 	...
 	<tr>
 	<form action="qdfir601Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">DATE APPROVED</font></b></td>
	<td align="center"><b><font color="#336699" size="2">APPROVED LIMIT</font></b></td>
	<td align="center"><b><font color="#336699" size="2">NAIRA</font></b></td>
	<td align="center"><b><font color="#336699" size="2">PERCENT</font></b></td>
	<td align="center"><b><font color="#336699" size="2">UNDRAWN COMMITMENT</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR601.S_NO, QDFIR601.CUSTOMERNAME, QDFIR601.DATEAPPROVED, QDFIR601.APPROVEDLIMIT, QDFIR601.AMOUNTDRAWNNAIRA, QDFIR601.AMOUNTDRAWNPERCENT, QDFIR601.UNDRAWNCOMMITMENT FROM QDFIR601 where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QDFIR601 where S_NO='T_99999'");
		while(rs.next())
		{
