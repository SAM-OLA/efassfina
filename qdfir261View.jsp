...
<form name"frm" method="POST" action="qdfir261Customise.jsp">
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir261");
		rs=pst.executeQuery();
...
<%
	...
	{
		out.println("QDFIR 261 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
