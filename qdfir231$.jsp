...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir231");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 231</title>
...
<br>
    ...
    <tr>
        <form action="qdfir231$.jsp" method="post" name="form231">
 	...
 	<tr>
 	<form action="qdfir231Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR231.S_NO, QDFIR231.INSTITUTIONCODE, Banks.BankName, QDFIR231.TYPEOFBALANCE, QDFIR231.ACCTNo, QDFIR231.AMOUNT, QDFIR231.REMARKS FROM Banks INNER JOIN QDFIR231 ON Banks.BankCode = QDFIR231.INSTITUTIONCODE where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir231 where S_NO='T_99999'");
		while(rs.next())
		{
