...
<%
	...
	{
		out.println("mpmbr344Validate Error: "+e.toString());
	}
	...
	pst=cn.prepareStatement("select [STATE_GOVTS],[LOCAL_GOVTS],[TOTAL_CREDIT] from mpmbr344Data where code='41500'");
