...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from per305");
		while(rs.next())
		{
			cn++;
		}
...
<title>CBN EFASS System - PER 305</title>
...
<br>
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
        <tr>
          ...
          <td width="1066">
          <p align="center"><b><font size="2">CAPTURE LIST OF OUTSTANDING FRAUDS AND FORGERIES- PER 305</font></b></td>
          <td width="18">&nbsp;</td>
        </tr>
</table>
<br>
    ...
    <tr>
    <form action="per305$.jsp" method="post">
 	...
 	<tr>
 	<form action="per305customise.jsp" method="post">
	...
	<td>BRANCH</td>
	<td>DATE</td>
	<td>OFFICER (S) INVOLVED</td>
	<td>NATURE OF FRAUD</td>
	<td>EXPECTED LOSS</td>
	<td>ACTUAL LOSS</td>
	<td>REMARK(S)</td>
	</tr>
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from per305 where S_NO='"+i+"'");
			while(rs.next())
			{
				f1=rs.getString(2);
				f2=rs.getString(3);
    	...
    	String ss1="", ss2="";
    	Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select EXPECTED_LOSS,ACTUAL_LOSS from per305 where S_NO='T_99999'");
		while(rs.next())
		{
