...
<form name"frm" method="POST" action="qdfir196Customise.jsp">
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir196");
		rs=pst.executeQuery();
...
<%
	...
	{
		out.println("QDFIR 196 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
