...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mtr205del.jsp");
	}
	try
	{
		connect c = new connect();
   		Connection cnn = c.connectMethod();
		PreparedStatement pss=cnn.prepareStatement("delete from mtr205");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mtr205 values(?,?,?,?,?,?,?,?,?,?,?,?)");		
		...
		pss.setString(8,String.valueOf(acost)); 	
