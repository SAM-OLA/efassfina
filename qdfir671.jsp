...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir671");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 671</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 671 - SCHEDULE OF PLACEMENTS FROM OTHER FINANCIAL INSTITUTION</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qdfir671$.jsp" method="post" name="form671">
 	...
 	<tr>
 	<form action="qdfir671Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">INST. CODE</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR671.S_NO, QDFIR671.BANKCODE, Banks.BankName, QDFIR671.ACCTNo, QDFIR671.AMOUNT FROM Banks INNER JOIN QDFIR671 ON Banks.BankCode = QDFIR671.BANKCODE where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QDFIR671 where S_NO='T_99999'");
		while(rs.next())
		{
