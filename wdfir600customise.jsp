...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("wdfir600del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from wdfir600");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into wdfir600 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
