...
<%
	...
	{
		out.println("mpmbr100Validate Error: "+e.toString());
	}
	...
	pst=cn.prepareStatement("select [STATE_GOVTS],[LOCAL_GOVTS],[TOTAL_CREDIT] from mpmbr100Data where code='41500'");
