...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per405del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per405");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per405 values(?,?,?,?,?,?,?)");		
