...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from spmbr1970");
		while(rs.next())
		{
			cn++;
		}
...
<title>CBN EFASS System - SPMBR 1970</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <a href='spmbrtoc.jsp'>SDFIR TOC</a> </font></b> </td>
    <td width="1074">
<p align="center"><b><font color="#336699" size="2">SEMI-ANNUAL RETURN ON CLOSURE OF BRANCHES - SPMBR 1970</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
    <form action="spmbr1970$.jsp" method="post">
     <td width="62><b><font color="#336699" size="2">&nbsp;New_Entries</font></b></td>&nbsp; <td>
     <b><font color="#336699" size="2">
 	...
 	<tr>
 	<form action="spmbr1970customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from spmbr1970 where S_NO='"+i+"'");
