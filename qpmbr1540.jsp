...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from QPMBR1540Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from QPMBR1540");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into QPMBR1540Data Values(?,?,?)");
...
<title>Cube CBN EFASS System - QPMBR 1540</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QPMBR 1540 - Schedule of Non-Interest Income</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qpmbr1540$.jsp" method="post" name="form1540">
 	...
 	<tr>
 	<form action="qpmbr1540Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QPMBR1540Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QPMBR1540Data where S_NO='T_99999'");
		while(rs.next())
		{
