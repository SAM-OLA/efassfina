...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per303del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per303");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per303 values(?,?,?,?,?)");		
