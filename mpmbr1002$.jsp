...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from mpmbr1002");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - MPMBR 1002</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 1002 - SCHEDULE OF OTHER OPERATING INCOME</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr1002$.jsp" method="post" name="form1002">
 	...
 	<tr>
 	<form action="mpmbr1002Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT MPMBR1002.S_NO, MPMBR1002.ITEMDESCRIPTION, MPMBR1002.AMOUNT FROM MPMBR1002 where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
			ResultSet rs=st2.executeQuery("select * from mpmbr1002 where S_NO='T_99999'");
		while(rs.next())
		{
