...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("spmbr1910Edel.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from spmbr1910E");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into spmbr1910E values(?,?,?,?,?,?,?)");		
...
%>
		  <SCRIPT Language = "JavaScript">
		    ...
		    window.location = 'spmbr1910E.jsp';
    		</SCRIPT>
<%
	}
	catch(Exception e)
