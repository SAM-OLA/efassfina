...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("qpmbr1510del.jsp");
	}
	try
	{
		connect c = new connect();
   		Connection cnn = c.connectMethod();
		PreparedStatement pss=cnn.prepareStatement("delete from qpmbr1510");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into qpmbr1510 values(?,?,?,?,?,?)");		
		...
		pss.setString(6,String.valueOf(ls_format1.format(anom1)));
