...
<br>
    ...
    <tr>
        <form action="qpmbr1520$.jsp" method="post" name="form11520">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QPMBR1520 where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
				...
				out.println("<td ><input type=\"text\" name=\"f5" +i+ "\"  value=\"01/01/2013\"></td >");	
				out.println("<td ><input type=\"text\" name=\"f6" +i+ "\"  value=\"01/01/2013\"></td >");
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QPMBR1520 where S_NO='T_99999'");
		while(rs.next())
		{
