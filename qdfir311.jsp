...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from QDFIR311Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from qdfir311");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into qdfir311Data Values(?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - QDFIR 311</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 311 - SCHEDULE OF BALANCES HELD WITH BANKS IN NIGERIA</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qdfir311$.jsp" method="post" name="form311">
 	...
 	<tr>
 	<form action="qdfir311Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QDFIR311Data where S_NO='"+i+"'");
			...
			while(rs.next())
			{
				...
				out.println("<td ><input type=\"text\" readonly name=\"f1" +i+ "\" size=\"62\" value=\""+f1+"\"></td >");	
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QDFIR311Data where S_NO='T_99999'");
		while(rs.next())
		{
