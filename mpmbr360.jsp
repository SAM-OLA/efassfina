...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR360Data");
            pss.executeUpdate();
            pss.close();
		...
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR360Data Values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
<br>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR360Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR360Data where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(19).trim());
			...
			out.println("<td><input type=\"text\" name=\"total11\" value=\"0\"></td >");											out.println("<td><input type=\"text\" name=\"total12\" value=\"0\"></td >");											out.println("<td><input type=\"text\" name=\"total13\" value=\"0\"></td >");											out.println("<td><input type=\"text\" name=\"total14\" value=\"0\"></td >");											out.println("<td><input type=\"text\" name=\"total15\" value=\"0\"></td >");											out.println("<td><input type=\"text\" name=\"total16\" value=\"0\"></td >");											out.println("<td><input type=\"text\" name=\"total17\" value=\"0\"></td >");											out.println("<td><input type=\"text\" name=\"total18\" value=\"0\"></td >");											out.println("<td><input type=\"text\" name=\"total19\" value="+ss1+"></td >");	
			out.println("</tr>");
			out.println("</table>");
