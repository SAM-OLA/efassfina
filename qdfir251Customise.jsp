...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("qdfir251del.jsp");
	}
	try
	{
		connect c = new connect();
   		Connection cnn = c.connectMethod();
		PreparedStatement pss=cnn.prepareStatement("delete from qdfir251");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into qdfir251 values(?,?,?,?)");		
			pss.setString(1,count);
			pss.setString(2,f1);
			pss.setString(3,f2);
			pss.setString(4,f3);
			anom3+=Integer.parseInt(f3);
			pss.executeUpdate();
		...
		pss.setString(4,String.valueOf(anom3));
