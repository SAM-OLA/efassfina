...
<br>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR251.S_NO, QDFIR251.INSTITUTIONCODE, Banks.BankName, QDFIR251.AMOUNT FROM Banks INNER JOIN QDFIR251 ON Banks.BankCode = QDFIR251.INSTITUTIONCODE where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir251 where S_NO='T_99999'");
		while(rs.next())
		{
