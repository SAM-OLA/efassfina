...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from MTR217");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - MTR 217</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MTR 217 - CUSTOMER INFORMATION</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mtr217$.jsp" method="post" name="form217">
 	...
 	<tr>
 	<form action="mtr217customise.jsp" method="post">
 	<td valign="bottom">
    <p align="center"><b><font color="#336699" size="2"><input type="checkbox" name="CheckAll" onClick="if (this.checked){doClickAll(this.form)} else {doUnClickAll(this.form)}" value="ON">Delete_All</font></b></td>
	<td valign="bottom" >
    <p align="center"><b><font color="#336699" size="2">S_NO</font></b></td>
	<td valign="bottom" >
    <p align="center"><b><font color="#336699" size="2">RC NO/ PASSPORT NO</font></b></td>
	<td valign="bottom" >
    <p align="center"><b><font color="#336699" size="2">CLIENT NAME</font></b></td>
	<td valign="bottom" >
    <p align="center"><b><font color="#336699" size="2">NEPC NO</font></b></td>
	<td valign="bottom" >
    <p align="center"><b><font color="#336699" size="2">ADDRESS</font></b></td>
	<td valign="bottom" >
    <p align="center"><b><font color="#336699" size="2">CITY</font></b></td>
	<td valign="bottom" >
    <p align="center"><b><font color="#336699" size="2">STATE</font></b></td>
	<td valign="bottom" >
    <p align="center"><b><font color="#336699" size="2">DATE REGISTERED</font></b></td>
	<td valign="bottom" >
    <p align="center"><b><font color="#336699" size="2">DOM ACCOUNT NUM</font></b></td>
	<td valign="bottom" >
    <p align="center"><b><font color="#336699" size="2">EMAIL ADDRESS</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from mtr217 where S_NO='"+i+"'");
			Statement stCity =cnn.createStatement();
			ResultSet rsCity = stCity.executeQuery("select * from CityCodes");
			Statement stState =cnn.createStatement();
			ResultSet rsState = stState.executeQuery("select * from StateCodes");
			...
			while(rs.next())
			{
				...
				while(rsCity.next())
					{
						String str1 = rsCity.getString(1);
						String str2 = rsCity.getString(2);
        					if(f5.equals(str1))
        					{
