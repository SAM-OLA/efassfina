...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR318CData");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR318C");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR318CData Values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 318.3</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 318.3 - SCHEDULE OF TREASURY BILLS - Held To Maturity (HTM)</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr318C$.jsp" method="post" name="form318C">
 	...
 	<tr>
 	<form action="mpmbr318CCustomise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">DATE SOLD</font></b></td>
	<td align="center"><b><font color="#336699" size="2">SERIES NO</font></b></td>
	<td align="center"><b><font color="#336699" size="2">PORTION SOLD(=N=)</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR318CData where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR318CData where S_NO='T_99999'");
		while(rs.next())
		{
