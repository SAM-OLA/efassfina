...
<title>Cube Group - MPMBR Configuaration File</title>
...
<p><b><font color="#336699" size="2">&nbsp;MPMBR CONFIGURATION SETTINGS</font></b></p>
<form name="frm" method="POST" action="storeConfigurationMPMBR.jsp">
