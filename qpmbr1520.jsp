...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from QPMBR1520Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from QPMBR1520");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into QPMBR1520Data Values(?,?,?,?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - QPMBR 1520</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QPMBR 1520 - Schedule of Credit to Directors/Employees/Significant Shareholders & Related Interests / LEASES</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qpmbr1520$.jsp" method="post" name="form1520">
 	...
 	<tr>
 	<form action="qpmbr1520Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">NO DATA</font></b></td>	
	<td align="center"><b><font color="#336699" size="2">Relationship Institution</font></b></td>
	<td align="center"><b><font color="#336699" size="2">Date Granted</font></b></td>
	<td align="center"><b><font color="#336699" size="2">Date Due</font></b></td>
	...
	<td align="center"><b><font color="#336699" size="2">Remark(Performing/Non Performing) </font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QPMBR1520Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QPMBR1520Data where S_NO='T_99999'");
		while(rs.next())
		{
			...
			out.println("<td><input type=\"text\" readonly name=\"total4\" value=\"0\"></td >");
