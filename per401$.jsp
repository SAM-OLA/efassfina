...
<br>
    ...
    <tr>
    <form action="per401$.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from per401 where S_NO='"+i+"'");
			while(rs.next())
			{
				f1=rs.getString(2);
				f2=rs.getString(3);
    	...
    	String ss1="", ss2="";
    	Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from PER401 where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(8));
