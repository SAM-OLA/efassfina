...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mpmbr348del.jsp");
	}
	try
	{
		connect c = new connect();
   		Connection cnn = c.connectMethod();
		PreparedStatement pss=cnn.prepareStatement("delete from mpmbr348");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mpmbr348 values(?,?,?,?,?,?,?,?)");		
		...
		pss.setString(5,String.valueOf(ls_format1.format(anom1)));
		pss.setString(6,String.valueOf(ls_format1.format(anom2)));
		pss.setString(7,String.valueOf(ls_format1.format(anom3)));
		pss.setString(8,String.valueOf(ls_format1.format(anom4)));
