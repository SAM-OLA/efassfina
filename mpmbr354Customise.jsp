...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mpmbr354del.jsp");
	}
	try
	{
		connect c = new connect();
   		Connection cnn = c.connectMethod();
		PreparedStatement pss=cnn.prepareStatement("delete from mpmbr354");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mpmbr354 values(?,?,?,?,?,?,?,?,?,?,?)");		
		...
		pss.setString(8,String.valueOf(request.getParameter("total7")));
		pss.setString(9,String.valueOf(request.getParameter("total7")));
		pss.setString(10,String.valueOf(request.getParameter("total7")));
		pss.setString(11,String.valueOf(anom1));
