...
<title>Cube Group - SPMBR Configuaration File</title>
...
<p><b><font color="#336699" size="2">&nbsp;SPMBR CONFIGURATION SETTINGS</font></b></p>
<form name="frm" method="POST" action="storeConfigurationSPMBR.jsp">
