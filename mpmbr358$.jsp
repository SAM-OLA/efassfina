...
<br>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR358 where S_NO='"+i+"'");
			...
			while(rs.next())
			{
				...
				out.println("<td ><input type=\"text\" name=\"f2" +i+ "\" size=\"60\" value=\""+f2+"\"></td >");	
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
				...
				while(rsBanks.next())
        			...
        			out.println("</select></td>");
				out.println("<td ><input type=\"text\" name=\"f2" +i+ "\" size=\"60\"  value=\"0\"></td >");	
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR358 where S_NO='T_99999'");
		while(rs.next())
		{
