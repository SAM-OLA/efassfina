...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from wdfir200");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - WDFIR 200</title>
...
<br>
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
        <tr>
          ...
          <td width="1066">
          <p align="center"><b><font size="2">RETURN ON MONEY LAUNDERING - WDFIR 200</font></b></td>
          <td width="18">&nbsp;</td>
        </tr>
</table>
<br>
    ...
    <tr>
    <form action="wdfir200$.jsp" method="post">
...
<td></td>
 	...
 	<tr>
 	<form action="wdfir200customise.jsp" method="post">
	...
	<td align="center" valign="bottom" ><b><font size="2">Customer’s Address (Not P O Box)</font></b></td>
	...
	<td align="center" valign="bottom" ><b><font size="2">Name of Sender</font></b></td>
	<td align="center" valign="bottom" ><b><font size="2">Address (Not P O Box)</font></b></td>
	<td align="center" valign="bottom" ><b><font size="2">No of Beneficiaries (If different from Customer)</font></b></td>
	<td align="center" valign="bottom" ><b><font size="2">Address of Beneficiary (If different from Customer)</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from wdfir200 where S_NO='"+i+"'");
			while(rs.next())
			{
				f1=rs.getString(2);
				f2=rs.getString(3);
