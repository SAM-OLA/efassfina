...
<head>
<title>Cube CBN EFASS System - qdfir 102</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">SCHEDULE OF CURRENT ACCOUNT BALANCES DUE TO OTHER BANKS - qdfir 102</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
...
<form method="POST" action="qdfir102CustomiseTemp.jsp">
...
<%
	try
	{
		...
		pst=cn.prepareStatement("select * from qdfir102");
		rs=pst.executeQuery();
