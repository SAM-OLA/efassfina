...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir531");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 531</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 531 - SCHEDULE OF COUNTERPARTS FUNDS [OTHERS]</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
...
<%
		...
		ResultSet rs3=st3.executeQuery("select value from qdfir300Data where code='20530'");
		rs3.next();
%>
Note: Expected Total: <%=rs3.getString(1)%> 
    ...
    <tr>
        <form action="qdfir531$.jsp" method="post" name="form531">
 	...
 	<tr>
 	<form action="qdfir531Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR531.S_NO, QDFIR531.ITEMDESCRIPTION, QDFIR531.AMOUNT FROM QDFIR531 where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QDFIR531 where S_NO='T_99999'");
		while(rs.next())
		{
