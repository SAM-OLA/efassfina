...
<br>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR261.S_NO, QDFIR261.ITEMDESCRIPTION, QDFIR261.AMOUNT FROM QDFIR261 where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir261 where S_NO='T_99999'");
		while(rs.next())
		{
