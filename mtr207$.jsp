...
<%
	connect c = new connect();
   		cnn = c.connectMethod();	int cn=0;
	try
	{
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from mtr207");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - MTR 207</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MTR 207 - ANALYSIS OF FOREIGN EXCHANGE UTILIZATION ON FORM 'M' (L/C VALID FOR FOREIGN EXCHANGE) SOURCED FROM CBN SALES</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mtr207$.jsp" method="post" name="form207">
...
<td></td>
 	...
 	<tr>
 	<form action="mtr207customise.jsp" method="post">
	...
	<td align="left" valign="bottom"><b><font color="#336699" size="2">EXCHANGE RATE AT WHICH FUND WAS PURCHASED FROM CBN</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from mtr207 where S_NO='"+i+"'");
			Statement stVisibleImportExportCode =cnn.createStatement();
			ResultSet rsVisibleImportExportCode = stVisibleImportExportCode.executeQuery("select * from HSCodes order by Description");
	...
	String ss4="0";
    	Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select UTILISED,ALLOCATED,EXCHANGE_RATE_AT_WHICH_FUND_WAS_PURCHASED_FROM_CBN from mtr207 where S_NO='T_99999'");
		while(rs.next())
		{
