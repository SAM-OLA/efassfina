...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mpmbr408del.jsp");
	}
	try
	{
		connect c = new connect();
   		Connection cnn = c.connectMethod();
		PreparedStatement pss=cnn.prepareStatement("delete from mpmbr408");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mpmbr408 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
		...
		pss.setString(15,String.valueOf(anom1));
