...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from mtr211");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - MTR 211</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MTR 211 View - CAPTURE BREAKDOWN OF UTILIZATION (FORM ‘M’ FOR FOODS UNDER FINISHED GOODS)</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
 	...
 	<tr>
 	<form action="mtr211customise.jsp" method="post">
	...
	<td align="center" valign="bottom" ><b><font color="#336699" size="2">NAME OF<br>
    APPLICANT<br>
    (IMPORTER)</font></b></td>
	<td align="center" valign="bottom" ><b><font color="#336699" size="2">SOURCE<br>
    OF FUND</font></b></td>
	<td align="center" valign="bottom" ><b><font color="#336699" size="2">IMPORT ITEM</font></b></td>
	<td align="center" valign="bottom" ><b><font color="#336699" size="2">AMOUNT<br>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from mtr211 where S_NO='"+i+"'");
    	...
    	String ss2="0";
	    	Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select AMOUNTUTILISED_US$ from mtr211 where S_NO='T_99999'");
		while(rs.next())
		{
