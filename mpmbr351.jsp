...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from mpmbr351Data");
		while(rs.next())
		{
			cn++;
		}
...
<br>
    ...
    <tr>
        <form action="mpmbr351$.jsp" method="post" name="form351">
    ...
    <%
    	...
    	//{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR351Data");
