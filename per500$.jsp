...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from per500");
		while(rs.next())
		{
			cn++;
		}
...
<title>CBN EFASS System - PER 500</title>
...
<br>
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
        <tr>
          ...
          <td width="1066">
          <p align="center"><b><font size="2">SUBMISSION OF ACQUIRED FOREIGN EXCHANGE BY A BANK IN A SPECIFIED PERIOD- PER 500</font></b></td>
          <td width="18">&nbsp;</td>
        </tr>
</table>
<br>
    ...
    <tr>
    <form action="per500$.jsp" method="post">
 	...
 	<tr>
 	<form action="per500customise.jsp" method="post">
	...
	<td>SOURCE NAME</td>
	<td>BANK CODE BID NUMBER LC NUMBER</td>
	<td>VALUE US$</td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from per500 where S_NO='"+i+"'");
			Statement stCategorization =cnn.createStatement();
			ResultSet rsCategorization = stCategorization.executeQuery("select * from PER500CATEGORIZATION");
			...
			while(rs.next())
			{
				...
				while(rsCategorization.next())
					{
						String str1 = rsCategorization.getString(1);
						String str2 = rsCategorization.getString(2);
        					if(f6.equals(str1))
        					{
    	...
    	String ss1="", ss2="";
    	Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from per500 where S_NO='T_99999'");
		while(rs.next())
		{
