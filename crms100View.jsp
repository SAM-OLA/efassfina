...
<br>
  ...
  <!--</tr>-->
	...
	<td ><b><font color="#336699" size="2">10015 Qualification(s)(M)</font></b></td>
	<td ><b><font color="#336699" size="2">10016 Banker(s)(M)</font></b></td>
	<td ><b><font color="#336699" size="2">10017 Referee(s)(O)</font></b></td>
	<td ><b><font color="#336699" size="2">Edit</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			while(rs.next())
			{
				...
				out.println("<td><a href=crms100edit.jsp?target="+i+" style='color:pink;'>Data</a></td>");
    				out.println("</tr> ");
