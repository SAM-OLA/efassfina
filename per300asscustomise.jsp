...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per300assdel.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per300ass");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per300ass values(?,?,?,?,?,?,?,?,?)");		
