...
<title>SDFIR Customise Form</title>
...
<%
	...
	{	
		...
		{
%>
<p align="center"><u><b>SDFIR Customise Form - Table Of Content</b></u></p>
<center>
  ...
  <tr style="height: 12.75pt">
    ...
    <a href="sdfir1910View.jsp">
  <img border="0" src="images/globe.gif" width="21" height="20"></a></font></td>
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><b><font face="Tahoma" size="2">SDFIR 
    1910
    SEMI-ANNUAL RETURN ON CORPORATE PROFILE </font></b></td>
  </tr>
  <tr style="height: 12.75pt">
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><font face="Tahoma">
    <a href="sdfir1920View.jsp">
  <img border="0" src="images/globe.gif" width="21" height="20"></a></font></td>
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><b><font face="Tahoma" size="2">SDFIR 
    1920
    SEMI-ANNUAL RETURN ON BRANCH NETWORK </font></b></td>
  </tr>
  <tr style="height: 12.75pt">
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><font face="Tahoma">
    <a href="sdfir1930View.jsp">
  <img border="0" src="images/globe.gif" width="21" height="20"></a></font></td>
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><b><font face="Tahoma" size="2">SDFIR 
    1930
    SEMI-ANNUAL RETURN ON BANK'S DIRECTORS </font></b></td>
  </tr>
  <tr style="height: 12.75pt">
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><font face="Tahoma">
    <a href="sdfir1940View.jsp">
  <img border="0" src="images/globe.gif" width="21" height="20"></a></font></td>
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><b><font face="Tahoma" size="2">SDFIR 
    1940
    SEMI-ANNUAL RETURN ON BANK'S SHAREHOLDERS </font></b></td>
  </tr>
  <tr style="height: 12.75pt">
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><font face="Tahoma">
    <a href="sdfir1950View.jsp">
  <img border="0" src="images/globe.gif" width="21" height="20"></a></font></td>
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><b><font face="Tahoma" size="2">SDFIR 
    1950
    SEMI-ANNUAL RETURN ON MANAGEMENT AND TOP OFFICERS </font></b></td>
  </tr>
</table>
</center>
<%
