...
<%
	...
	{
		out.println("mpmbr410Validate Error: "+e.toString());
	}
	...
	pst=cn.prepareStatement("select [STATE_GOVTS],[LOCAL_GOVTS],[TOTAL_CREDIT] from mpmbr410Data where code='41500'");
