...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per300liabdel.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per300liab");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per300liab values(?,?,?,?,?,?,?,?,?)");		
			...
			anom+=Double.parseDouble(f6);
			acost+=Double.parseDouble(f8);
			//anum+=Double.parseDouble(f5);
			pss.executeUpdate();
		...
		pss.setString(7,String.valueOf(anom)); 	
		pss.setString(8,String.valueOf(request.getParameter("total8"))); 	
		pss.setString(9,String.valueOf(acost)); 	
		pss.executeUpdate();                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       	
		cnn.close();
		%>
		<SCRIPT Language = "JavaScript">
		    alert("Data Successful saved");
		    window.location = 'per300liab.jsp';
	      </SCRIPT>
		<%
	}
	catch(Exception e)
