   	...
   	String f1="", f2="", f3="", f4="", f5="", f6="", f7="", f8="", f9="";
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
    		...
    		out.println("<td ><input type=\"text\" name=\"f1" +i+ "\"></td >");	
				...
				out.println("<td ><input type=\"text\" name=\"f3" +i+ "\" onBlur=\"return validate(this)\" value=\"0\"></td >");
				out.println("<td ><input type=\"text\" name=\"f4" +i+ "\" onBlur=\"return validate(this)\" value=\"0\" ></td >");
