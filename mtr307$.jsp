...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MTR 307 - MONTHLY ANALYSIS OF PRIVATE SECTOR EXTERNAL INVESTMENTS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mtr307$.jsp" method="post" name="form307">
...
<td></td>
<td></td>
<td colspan=3 align=center><b>------------------EXTERNAL INVESTMENT------------------</b></td>
<td colspan=2 align=center><b>------DIVIDENDS / INTEREST RECEIVED------</b></td>
<td></td>
	...
	<td align="center" valign="bottom"><p align="center"><b><font color="#336699" size="2">S_NO</font></b></td>
	<td align="center" valign="bottom"><p align="center"><b><font color="#336699" size="2">NAME OF CREDITOR</font></b></td>
	<td align="center" valign="bottom"><p align="center"><b><font color="#336699" size="2">RC NUMBER</font></b></td>
	<td align="center" valign="bottom"><p align="center"><b><font color="#336699" size="2">NAME OF BENEFICIARY</font></b></td>
	<td align="center" valign="bottom"><p align="center"><b><font color="#336699" size="2">TOTAL AMT ORIG CURRENCY</font></b></td>
	<td align="center" valign="bottom"><p align="center"><b><font color="#336699" size="2">TOTAL AMT US DOLLARS</font></b></td>
	<td align="center" valign="bottom"><p align="center"><b><font color="#336699" size="2">DATE</font></b></td>
	<td align="center" valign="bottom"><p align="center"><b><font color="#336699" size="2">ORIG CURRENCY</font></b></td>
	<td align="center" valign="bottom"><p align="center"><b><font color="#336699" size="2">US DOLLARS</font></b></td>
	<td align="center" valign="bottom"><p align="center"><b><font color="#336699" size="2">COUNTRY</font></b></td>
	</tr>
    <%
    	try
		{
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rsInstitutions = stInstitutions.executeQuery("select * from Institutions  order by Names");
			Statement stCountryCodes =cnn.createStatement();
			ResultSet rsCountryCodes = stCountryCodes.executeQuery("select * from CountryCodes");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
			...
			ResultSet rsCountryCodes = stCountryCodes.executeQuery("select * from CountryCodes");
				...
				out.println("<td ><input type=\"text\" name=\"f4" +i+ "\" value=\"0.00\"></td >");
				out.println("<td ><input type=\"text\" name=\"f5" +i+ "\" value=\"0.00\"></td >");
				out.println("<td ><input type=\"text\" name=\"f6" +i+ "\" value=\"0\"></td >");
				out.println("<td ><input type=\"text\" name=\"f7" +i+ "\" value=\"0.00\"></td >");
				out.println("<td ><input type=\"text\" name=\"f8" +i+ "\" value=\"0.00\"></td >");
				out.println("<td ><select name=\"f9" +i+ "\">");
				out.println("<option value=''>------Select------</option>");
				while(rsCountryCodes.next())
					{
