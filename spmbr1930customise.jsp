...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("spmbr1930del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from spmbr1930");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into spmbr1930 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
