...
<form name"frm" method="POST" action="qdfir232Customise.jsp">
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir232");
		rs=pst.executeQuery();
...
<%
	...
	{
		out.println("QDFIR 232 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
