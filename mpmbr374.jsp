...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR374Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR374");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR374Data Values(?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 374</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    <td width="73">
    <b><font color="#336899" size="2">
    <a href='mpmbrtoc.jsp'>MPMBR TOC</a> </font></b> </td>
    <td width="1063">
<p align="center"><b><font color="#336899" size="2">MPMBR 374 - SCHEDULE OF BALANCES DUE TO OTHER PMBs / FINANCIAL INSTITUTIONS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr374$.jsp" method="post" name="form374">
     <td><b><font color="#336899" size="2">&nbsp;New_Entries</font></b></td>&nbsp; <td>
     <b><font color="#336899" size="2">
 	...
 	<tr>
 	<form action="mpmbr374Customise.jsp" method="post">
 	<td><b><font color="#336899" size="2"><input type="checkbox" name="CheckAll" onClick="if (this.checked){doClickAll(this.form)} else {doUnClickAll(this.form)}" value="ON">Delete_All</font></b></td>
	<td align="center"><b><font color="#337099" size="2">S_NO</font></b></td>
	<td align="center"><b><font color="#337099" size="2">INSTITUTION CODE</font></b></td>
	<td align="center"><b><font color="#337099" size="2">INSTITUTION NAME</font></b></td>	
	<td align="center"><b><font color="#337099" size="2">AMOUNT</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR374Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR374Data where S_NO='T_99999'");
		while(rs.next())
		{
