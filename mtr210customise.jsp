...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mtr210del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from mtr210");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mtr210 values(?,?,?,?,?,?,?,?)");		
