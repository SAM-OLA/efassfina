...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mpmbr406del.jsp");
	}
	try
	{
		connect c = new connect();
   		Connection cnn = c.connectMethod();
		PreparedStatement pss=cnn.prepareStatement("delete from mpmbr406");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mpmbr406 values(?,?,?,?,?,?,?)");		
		...
		pss.setString(7,String.valueOf(anom1));
