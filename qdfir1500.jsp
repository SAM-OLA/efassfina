...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from QDFIR1500Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from qdfir1500");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into qdfir1500Data Values(?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - QDFIR 1500</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
	<p align="center"><b><font color="#336699" size="2">QDFIR 1500 - SCHEDULE OF OFF BALANCE SHEET ENGAGEMENTS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qdfir1500$.jsp" method="post" name="form1500">
 	...
 	<tr>
 	<form action="qdfir1500Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">TOTAL VALUE OF ENGAGEMENTS</font></b></td>
	<td align="center"><b><font color="#336699" size="2">TOTAL NON PERFORMING OFF BALANCE SHEET ENGAGEMENTS</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QDFIR1500Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QDFIR1500Data where S_NO='T_99999'");
		while(rs.next())
		{
