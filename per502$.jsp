...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from per502");
		while(rs.next())
		{
			cn++;
		}
...
<title>CBN EFASS System - PER 502</title>
...
<br>
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
        <tr>
          ...
          <td width="1066">
          <p align="center"><b><font size="2">SUBMISSION OF INTEREST REPATRATION ON QUARTELY BASIS FOR THE PERIOD COVERED BY THE EXAMINATION - PER 502</font></b></td>
          <td width="18">&nbsp;</td>
        </tr>
</table>
<br>
    ...
    <tr>
    <form action="per502$.jsp" method="post">
 	...
 	<tr>
 	<form action="per502customise.jsp" method="post">
    ...
    <%
   	...
   	String f1="", f2="", f3="", f4="", f5="", f6="";
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from per502 where S_NO='"+i+"'");
			while(rs.next())
			{
				f1=rs.getString(2);
				f2=rs.getString(3);
    	...
    	String ss1="", ss2="", ss3="";
    	Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from per502 where S_NO='T_99999'");
		while(rs.next())
		{
