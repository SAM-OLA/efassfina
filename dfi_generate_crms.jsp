...
<%
	...
	String cr400 = request.getParameter("crms400");
        String cr500a = request.getParameter("crms500a");
        String cr500b = request.getParameter("crms500b");
	...
	if ( cr500a.equals("1") ) {
           crms500a c500a = new crms500a();
           c500a.setDayString(thisday);
           c500a.setInstname(bankname);
           c500a.setInstcode(bankcode);
           c500a.setOutputpath(outputpath);
           c500a.setSignatory1(signatory1);
           c500a.setSignatory2(signatory2);
           c500a.setContactName(contactname);
           c500a.setTelno(telno);
           c500a.setExtno(extno);
           boolean test = c500a.convert();
	}

	if ( cr500b.equals("1") ) {
           crms500b c500b = new crms500b();
           c500b.setDayString(thisday);
           c500b.setInstname(bankname);
           c500b.setInstcode(bankcode);
           c500b.setOutputpath(outputpath);
           c500b.setSignatory1(signatory1);
           c500b.setSignatory2(signatory2);
           c500b.setContactName(contactname);
           c500b.setTelno(telno);
           c500b.setExtno(extno);
           boolean test = c500b.convert();
	}
...
if ( tester ) {
  ...
  <SCRIPT Language = "JavaScript">
    ...
    window.location = 'dfi_crms_select.jsp';
    </SCRIPT>
    <%
    }
 %>
