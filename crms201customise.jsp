...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("crms201del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from crms201");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into crms201 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
