...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="985">
<p align="center"><b><font color="#336699" size="2">CRMS 201 - RETURN FOR DIRECTORS OF CORPORATE BORROWER FORM</font></b></p>     
    </td>
...
<body>
<form method="POST" action="crms201update.jsp">
<%
	PreparedStatement pst=cnn.prepareStatement("select * from crms201 where S_NO = ?");
...
<div align="center">
	...
	%>
     ...
     <tr>
        ...
        <td align="left"><b><font title="Allows you specify the corresponding values for each CBN item per report">DIRECTORS NAME (surname first) : </font></b></td>
	<%
