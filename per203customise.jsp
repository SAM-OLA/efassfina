...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per203del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per203");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per203 values(?,?,?,?,?)");		
