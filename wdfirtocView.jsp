...
<title>wdfirFIR Customise Form</title>
...
<%
	...
	{	
		...
		{
%>
<p align="center"><u><b>wdfirFIR Customise Form - Table Of Content</b></u></p>
<center>
  ...
  <tr>
    ...
    <a href="wdfir100View.jsp">
  <img border="0" src="images/globe.gif" width="21" height="20"></a></font></td>
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><b><font face="Tahoma" size="2">wdfirFIR 100 </font></b>
    <font SIZE="2"><b><font face="Tahoma">SCHEDULE OF INTEREST EARNED AND 
    DISTRIBUTED</font></b> </font></td>
  </tr>
  <tr style="height: 15.75pt">
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><font face="Tahoma">
    <a href="wdfir200View.jsp">
  <img border="0" src="images/globe.gif" width="21" height="20"></a></font></td>
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
  ...
  <tr style="height: 15.75pt">
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><font face="Tahoma">
    <a href="wdfir500View.jsp">
  <img border="0" src="images/globe.gif" width="21" height="20"></a></font></td>
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><b><font face="Tahoma" size="2">WDFIR 500 RETURN OF FOREIGN EXCHANGE ROUTINE
    </font></b> </td>
  </tr>
  <tr style="height: 15.75pt">
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><font face="Tahoma">
    <a href="wdfir600View.jsp">
  <img border="0" src="images/globe.gif" width="21" height="20"></a></font></td>
    <td height="25" class="cat" onmouseover="javascript:changeclass( this, 'catover' );" onmouseout="javascript:changeclass( this, 'cat' );">
    <p class="MsoNormal"><b><font face="Tahoma" size="2">WDFIR 600 RETURN ON LODGEMENT ON TRANSFER OF FUNDS  IN EXCESS
    </font></b> </td>
  </tr>
</table>
</center>
