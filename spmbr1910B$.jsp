...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from spmbr1910B");
		while(rs.next())
		{
			cn++;
		}
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1074">
<p align="center"><b><font color="#336699" size="2">SEMI-ANNUAL RETURN ON CORPORATE PROFILE <br>Foreign Subsidiary | Foreign Branches and Staff Summary - SPMBR 1910 -part 2</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
    <form action="spmbr1910B$.jsp" method="post">
    ...
    <td>
 	...
 	<tr>
 	<form action="spmbr1910Bcustomise.jsp" method="post">
	...
	<td align="center" valign="bottom"><b><font color="#336699" size="2">NAME OF SUBSIDIARY</font></b></td>
	...
	<td align="center" valign="bottom"><b><font color="#336699" size="2">COUNTYRY</font></b></td>
	...
	<td align="center" valign="bottom"><b><font color="#336699" size="2">COMPANY REGISTRATION NUMBER</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from spmbr1910B where S_NO='"+i+"'");
