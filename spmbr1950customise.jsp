...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("spmbr1950del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from spmbr1950");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into spmbr1950 values(?,?,?,?,?,?,?,?,?)");		
