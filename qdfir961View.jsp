...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 961 - SCHEDULE OF OTHER FIXED ASSETS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
...
<form name"frm" method="POST" action="qdfir961Customise.jsp">
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir961");
		rs=pst.executeQuery();
...
<%
	...
	{
		out.println("QDFIR 961 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
