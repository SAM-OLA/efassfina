...
<title>Cube CBN EFASS System - MPMBR 352</title>
<script>
</script>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1072">
<p align="center"><b><font color="#336699" size="2">SCHEDULE OF OTHER INTANGIBLE ASSETS - MPMBR - 352</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
...
<%
		...
		ResultSet rs3=st3.executeQuery("select Amount from mpmbr352Data where code='35225'");
		rs3.next();
%>
Note: Expected Total[TOTAL]: <%=rs3.getString(1)%> 
</pre>
<form name"frm" method="POST" action="mpmbr352Customise.jsp">
...
<%
	try
	{
		PreparedStatement pst1=cn1.prepareStatement("select count(*) from mpmbr352");
		ResultSet rs1=pst1.executeQuery();
		rs1.next();
		recCnt=rs1.getInt(1);

		PreparedStatement pst=cn.prepareStatement("select count(*) from mpmbr352");		
		pst=cn.prepareStatement("select Code,Description,Source,Amount,Impairment,[CARRYING AMOUNT] from mpmbr352");
		rs=pst.executeQuery();
...
<%
				out.println("<td><a href='mpmbr353Breakdown.jsp?target="+code+","+description+"'>Edit</a></td>");
%>
