...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR308Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR308");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR308Data Values(?,?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 308</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 308 - SCHEDULE OF BALANCES HELD WITH BANKS OUTSIDE NIGERIA</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr308$.jsp" method="post" name="form308">
 	...
 	<tr>
 	<form action="mpmbr308Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">COUNTRY</font></b></td>	
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR308Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR308Data where S_NO='T_99999'");
		while(rs.next())
		{
