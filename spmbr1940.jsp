...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from spmbr1940");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - SPMBR 1940</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1074">
<p align="center"><b><font color="#336699" size="2">SEMI-ANNUAL RETURN ON BANK'S SIGNIFICANT SHAREHOLDERS- SPMBR 1940</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
    <form action="spmbr1940$.jsp" method="post">
 	...
 	<tr>
 	<form action="spmbr1940customise.jsp" method="post">
	...
	<td align="center" valign="bottom"><b><font color="#336699" size="2">DATE OF BIRTH/INCORPORATION</font></b></td>
	...
	<td align="center" valign="bottom"><b><font color="#336699" size="2">RC/BR/SR/NID/ Number</font></b></td>
	<td align="center" valign="bottom"><b><font color="#336699" size="2">TIN NUMBER</font></b></td>
	<td align="center" valign="bottom"><b><font color="#336699" size="2">SHARE CERTIFICATE NUMBER/CSCS NO.</font></b></td>
	<td align="center" valign="bottom"><b><font color="#336699" size="2">SPACE HOLDER</font></b></td>
	<td align="center" valign="bottom"><b><font color="#336699" size="2">OWNERSHIP TYPE (GOVT/PRIVATE/INSTITUTIONAL)</font></b></td>
	<td align="center" valign="bottom"><b><font color="#336699" size="2">EQUITY INTEREST PERCENTAGE</font></b></td>
	<td align="center" valign="bottom"><b><font color="#336699" size="2">BENEFICIAL OWNERSHIP</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from spmbr1940 where S_NO='"+i+"'");
			Statement stspmbr1940TYPE_OF_OWNER =cnn.createStatement();
			ResultSet rsspmbr1940TYPE_OF_OWNER = stspmbr1940TYPE_OF_OWNER.executeQuery("select * from spmbr1940TYPE_OF_OWNER");
			...
			while(rs.next())
			{
				...
				while(rsspmbr1940TYPE_OF_OWNER.next())
					{
						String str1 = rsspmbr1940TYPE_OF_OWNER.getString(1);
						String str2 = rsspmbr1940TYPE_OF_OWNER.getString(2);
        					if(f10.equals(str1))
        					{
