...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from QDFIR351Data");
            pss.executeUpdate();
            pss.close();
		...
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into qdfir351Data Values(?,?,?,?,?,?)");
...
<br>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QDFIR351 where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QDFIR351Data where S_NO='T_99999'");
		while(rs.next())
		{
