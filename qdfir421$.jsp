...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir421");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 421</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 421 - SCHEDULE OF PLACEMENTS WITH OTHER DFI's/FINANCIAL INSTITUTIONS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qdfir421$.jsp" method="post" name="form421">
 	...
 	<tr>
 	<form action="qdfir421Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">INSTITUTION NAME</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR421.S_NO, QDFIR421.INSTITUTIONCODE, PMI.InstName, QDFIR421.TYPEOFPLACEMENTS, QDFIR421.ACCTNo, QDFIR421.AMOUNT, QDFIR421.TENOR, QDFIR421.EFFECTIVEDATE, QDFIR421.MATURITYDATE, QDFIR421.INTERESTRATE, QDFIR421.UPFRONTINTERESTRECEIVED, QDFIR421.ACCRUEDINTRECEIVABLE, QDFIR421.TIMESROLLEDOVER, QDFIR421.REMARKS FROM PMI INNER JOIN QDFIR421 ON PMI.InstCode = QDFIR421.INSTITUTIONCODE where S_NO='"+i+"'");
			Statement stBanks =cnn.createStatement();
			ResultSet rsBanks = stBanks.executeQuery("select * from PMI order by InstName");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir421 where S_NO='T_99999'");
		while(rs.next())
		{
