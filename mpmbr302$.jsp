...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from mpmbr302");
		while(rs.next())
		{
			cn++;
		}
...
<head>
<script type="text/javascript" src="cbnpmbifrs/atoll.js" tppabs="atoll.js"></script>
<link href="cbnpmbifrs/styles.css" tppabs="styles.css" rel="stylesheet" type="text/css">
<title>Cube CBN EFASS System - MPMBR 302</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 302 - SCHEDULE OF OTHER BALANCES HELD WITH CBN / FMBN</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr302$.jsp" method="post" name="form302">
 	...
 	<tr>
 	<form action="mpmbr302Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT MPMBR302.S_NO, MPMBR302.TYPEOFBALANCE, MPMBR302.AMOUNT FROM MPMBR302 where S_NO='"+i+"'");
			...
			while(rs.next())
			{
				...
				out.println("<td ><input type=\"text\" readonly name=\"count" +i+ "\" value="+i+ "></td >");
	    			out.println("<td ><input type=\"text\" name=\"f1" +i+ "\" value=\""+f2+"\"></td >");	
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
			ResultSet rs=st2.executeQuery("select * from mpmbr302 where S_NO='T_99999'");
		while(rs.next())
		{
