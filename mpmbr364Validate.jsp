...
<%
	...
	{
		out.println("mpmbr364Validate Error: "+e.toString());
	}
	...
	pst=cn.prepareStatement("select [STATE_GOVTS],[LOCAL_GOVTS],[TOTAL_CREDIT] from mpmbr364Data where code='41500'");
