...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR392Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR392");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR392Data Values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 392</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 392 - SCHEDULE OF CONTIGENT LIABILITIES</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr392$.jsp" method="post" name="form392">
 	...
 	<tr>
 	<form action="mpmbr392Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">CUSTOMER ADDRESS</font></b></td>	
	<td align="center"><b><font color="#336699" size="2">CUSTOMER ID</font></b></td>
	<td align="center"><b><font color="#336699" size="2">TRANSACTION CODE</font></b></td>
	<td align="center"><b><font color="#336699" size="2">TRANSACTION TYPE (guarantees, performance bond, litigations, LCs)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">AMOUNT</font></b></td>
	<td align="center"><b><font color="#336699" size="2">CURRENCY TYPE</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE BOOKED(Transaction Date)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">MATURITY DATE</font></b></td>
	<td align="center"><b><font color="#336699" size="2">BENEFICIARY</font></b></td>
	<td align="center"><b><font color="#336699" size="2">COLLATERAL TYPE</font></b></td>
	<td align="center"><b><font color="#336699" size="2">COLLATERAL VALUE</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DATE OF LAST RENEWAL</font></b></td>
	<td align="center"><b><font color="#336699" size="2">STATUS<br>(CLASSIFICATION)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">EXPECTED LOSS</font></b></td>	
	<td align="center"><b><font color="#336699" size="2">SECTOR</font></b></td>
    ...
    <%
    	try
		{
    	String f1="", f2="", f3="", f4="", f5="", f6="", f7="", f8="", f9="", f10="", af11="", af12="", af13="", af14="", af15="", af16="";    	
    	int ccn=cn-1;
    	for(int i=1;i<cn;i++) 
    	{
    			Statement st2=cnn.createStatement();
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR392Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR392Data where S_NO='T_99999'");
		while(rs.next())
		{
