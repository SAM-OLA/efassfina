...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from QDFIR421Data");
            pss.executeUpdate();
            pss.close();
		...
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into qdfir421Data Values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
<br>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QDFIR421 where S_NO='"+i+"'");
