...
<title>Cube Group - wbr Configuaration File</title>
...
<p><b><font color="#336699" size="2">&nbsp;WDFIR CONFIGURATION SETTINGS</font></b></p>
<form name="frm" method="POST" action="storeConfigurationWDFIR.jsp">
