...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per300contdel.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per300cont");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per300cont values(?,?,?,?,?,?,?,?,?)");		
		...
		<SCRIPT Language = "JavaScript">
		    ...
		    window.location = 'per300cont.jsp';
	      </SCRIPT>
		<%
	}
	catch(Exception e)
