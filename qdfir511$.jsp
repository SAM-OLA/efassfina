...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir511");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 511</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 511 - SCHEDULE OF COUNTERPART FUNDS [AIDS & GRANTS]</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qdfir511$.jsp" method="post" name="form511">
 	...
 	<tr>
 	<form action="qdfir511Customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR511.S_NO, QDFIR511.ITEMDESCRIPTION, QDFIR511.AMOUNT FROM QDFIR511 where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir511 where S_NO='T_99999'");
		while(rs.next())
		{
		...
		out.println("<td><input type=\"text\" name=\"total2\"  value=\"0\" size=\"62\"></td >");
