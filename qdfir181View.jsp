...
<form name"frm" method="POST" action="qdfir181Customise.jsp">
...
<%
	try
	{
		pst=cn.prepareStatement("select * from qdfir181");
		rs=pst.executeQuery();
...
<%
	...
	{
		out.println("QDFIR 181 View Error: "+e.toString());
	}
		cn.close();
%>
  </table>
