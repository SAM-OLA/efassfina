...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir1700");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 1700</title>
...
<br>
    ...
    <tr>
        <form action="qdfir1700$.jsp" method="post" name="form1700">
 	...
 	<tr>
 	<form action="qdfir1700Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">CRMS BORROWERS CODE</font></b></td>
	...
	<td align="center"><b><font color="#336699" size="2">CLASSIFIED AS NPA</font></b></td>
	<td align="center"><b><font color="#336699" size="2">DEBT INSTRUMENTS</font></b></td>
	<td align="center"><b><font color="#336699" size="2">INV</font></b></td>
	<td align="center"><b><font color="#336699" size="2">CONTIGENT LIABILITIES 20% OF VALUE</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QDFIR1700 where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir1700 where S_NO='T_99999'");
		while(rs.next())
		{
