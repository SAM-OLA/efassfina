...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from QPMBR1510Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from QPMBR1510");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into QPMBR1510Data Values(?,?,?,?,?,?)");
                  pstInsert.setString(1, rs.getString(1).trim());
                  pstInsert.setString(2, rs.getString(2).trim());
                  pstInsert.setString(3, rs.getString(3).trim());
                  pstInsert.setString(4, rs.getString(4).trim());
                  pstInsert.setString(5, rs.getString(5).trim());
                  pstInsert.setString(6, rs.getString(6).trim());
...
<title>Cube CBN EFASS System - QPMBR 1510</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <a href='qpmbrtoc.jsp'>QPMBR TOC</a> </font></b> </td>
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QPMBR 1510 - Schedule of Non-Performing Other Assets / LEASES</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qpmbr1510$.jsp" method="post" name="form1510">
 	...
 	<tr>
 	<form action="qpmbr1510Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">TOTAL OTHER ASSESTS</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QPMBR1510Data where S_NO='"+i+"'");
			...
			while(rs.next())
			{
				f1=rs.getString(2).trim();
				f2=rs.getString(3).trim();
				f3=rs.getString(4).trim();
				f4=rs.getString(5).trim();
				f5=rs.getString(6).trim();
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QPMBR1510Data where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(6).trim());
