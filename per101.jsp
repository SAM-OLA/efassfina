...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from per101");
		while(rs.next())
		{
			cn++;
		}
...
<title>CBN EFASS System - PER 101</title>
...
<br>
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
        <tr>
          ...
          <td width="1066">
          <p align="center"><b><font size="2">LIST OF MEMBERSHIP OF BOARD AND MANAGEMENT COMMITTEE- PER 101</font></b></td>
          <td width="18">&nbsp;</td>
        </tr>
</table>
<br>
    ...
    <tr>
    <form action="per101$.jsp" method="post">
 	...
 	<tr>
 	<form action="per101customise.jsp" method="post">
	...
	<td >FUNCTIONS</td>
	<td >NAME OF MEMBERS</td>
	<td >POSITION IN COMMITTEE</td>
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from per101 where S_NO='"+i+"'");
			while(rs.next())
			{
				f1=rs.getString(2);
				f2=rs.getString(3);
