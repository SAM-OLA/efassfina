...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from per302");
		while(rs.next())
		{
			cn++;
		}
...
<title>CBN EFASS System - PER 302</title>
...
<br>
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
        <tr>
          ...
          <td width="1066">
          <p align="center"><b><font size="2">CAPTURE ACCOUNTS OF ASSOCIATES/SUBSIDIARIES- PER 302</font></b></td>
          <td width="18">&nbsp;</td>
        </tr>
</table>
<br>
    ...
    <tr>
    <form action="per302$.jsp" method="post">
 	...
 	<tr>
 	<form action="per302customise.jsp" method="post">
 	<td width="50"><input type="checkbox" name="CheckAll" onClick="if (this.checked){doClickAll(this.form)} else {doUnClickAll(this.form)}" value="ON"><b><font size="2">Delete_All</font></b></td>
	<td>S_NO</td>
	<td width="350">ASSOCIATES/SUBSIDIARIES</td>
	<td>ACCOUNT NO</td>
	<td>ACCOUNT TYPE</td>
	<td>BALANCE</td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from per302 where S_NO='"+i+"'");
			while(rs.next())
			{
				f1=rs.getString(2);
				f2=rs.getString(3);
    	...
    	String ss1="";
    	Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select BALANCE from per302 where S_NO='T_99999'");
		while(rs.next())
		{
