...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from spmbr1910E");
		while(rs.next())
		{
			cn++;
		}
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1074">
<p align="center"><b><font color="#336699" size="2">SEMI-ANNUAL RETURN ON CORPORATE PROFILE <br>Details of Consultants / Service providers - SPMBR 1910 -part 5</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
    <form action="spmbr1910E$.jsp" method="post">
    ...
    <td>
 	...
 	<tr>
 	<form action="spmbr1910Ecustomise.jsp" method="post">
	...
	<td align="center" valign="bottom"><b><font color="#336699" size="2">NAME OF CONSULTANTS/SERVICE PROVIDERS</font></b></td>
	<td align="center" valign="bottom"><b><font color="#336699" size="2">SERVICE PROVIDED</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<=cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("select * from spmbr1910E where S_NO='"+i+"'");
