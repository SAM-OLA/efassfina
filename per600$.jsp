...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from per600");
		while(rs.next())
		{
			cn++;
		}
...
<title>CBN EFASS System - PER 600</title>
...
<br>
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
        <tr>
          ...
          <td width="1066">
          <p align="center"><b><font size="2">CAPTURE DETAILED CUSTOMER DEPOSIT INFORMATION - PER 600</font></b></td>
          <td width="18">&nbsp;</td>
        </tr>
</table>
<br>
    ...
    <tr>
    <form action="per600$.jsp" method="post">
 	...
 	<tr>
 	<form action="per600customise.jsp" method="post">
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs = st2.executeQuery("select * from per600 where S_NO='"+i+"'");
		
			while(rs.next())
			{
				Statement stAcctType=cnn.createStatement();
				ResultSet rsAcctType = stAcctType.executeQuery("select * from PER600ACCOUNT_TYPE");
				...
				while(rsAcctType.next())
					{
						String str1 = rsAcctType.getString(1);
						String str2 = rsAcctType.getString(2);
        					if(f5.equals(str1))
        					{
    	...
    	String ss1="", ss2="", ss3="";
    	Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from per600 where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(9));
