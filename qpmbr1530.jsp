...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from QPMBR1530Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from QPMBR1530");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into QPMBR1530Data Values(?,?,?,?,?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - QPMBR 1530</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QPMBR 1530 - Schedule of Top Users of Fund</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qpmbr1530$.jsp" method="post" name="form1530">
 	...
 	<tr>
 	<form action="qpmbr1530Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">Name</font></b></td>
	<td align="center"><b><font color="#336699" size="2">Sector</font></b></td>	
	<td align="center"><b><font color="#336699" size="2">CRMS Borrower Code</font></b></td>	
	<td align="center"><b><font color="#336699" size="2">RC/BR/SR/No</font></b></td>
	<td align="center"><b><font color="#336699" size="2">Total Loans & Advances/Leases</font></b></td>
	<td align="center"><b><font color="#336699" size="2">Classified as NPA(=N=)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">Debt Instruments (=N=)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">Investment (=N=)</font></b></td>
	<td align="center"><b><font color="#336699" size="2">Contingent Liabilities20% Value</font></b></td>
	<td align="center"><b><font color="#336699" size="2">Total Exposure</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM QPMBR1530Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from QPMBR1530Data where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(11).trim());
