...
<title>Cube Group - PER Configuaration File</title>
</head>
<center>
...
<p><b><font color="#336699" size="2">PER CONFIGURATION SETTINGS</font></b></p>
<form name="frm" method="POST" action="storeConfigurationPER.jsp">
