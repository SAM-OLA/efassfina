...
<%
	...
	try
	{
		PreparedStatement pss = cnn.prepareStatement("delete * from MPMBR406Data");
            pss.executeUpdate();
            pss.close();
		Statement st=cnn.createStatement();
		ResultSet rs=st.executeQuery("select * from MPMBR406");
		while(rs.next())
		{
			cn++;
			PreparedStatement pstInsert = cnn.prepareStatement("Insert into MPMBR406Data Values(?,?,?,?,?,?,?)");
...
<title>Cube CBN EFASS System - MPMBR 406</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 406 - SCHEDULE OF UNDRAWN COMMITMENT</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr406$.jsp" method="post" name="form406">
 	...
 	<tr>
 	<form action="mpmbr406Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">5a -N&#8217;000 AMOUNT DRAWN</font></b></td>
	<td align="center"><b><font color="#336699" size="2">5b -% AMOUNT DRAWN</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT * FROM MPMBR406Data where S_NO='"+i+"'");
    		...
    		String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from MPMBR406Data where S_NO='T_99999'");
		while(rs.next())
		{
			ss1=String.valueOf(rs.getString(7).trim());
