...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MTR 305 View - DETAILS OF TOTAL FOREX SALES TO END - USERS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rsCountryOfPayment = stCountryOfPayment.executeQuery("select * from CurrencyCodes");
	...
	String ss3="0";
		...
		out.println("<td ><input type=\"text\" name=\"total14\"  value="+ss3+"></td >");
