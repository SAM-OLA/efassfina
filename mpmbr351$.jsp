...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from mpmbr351Data where ITEMCODE ='"+code+"'");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - MPMBR 351</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MPMBR 351 - BREAKDOWN OF OTHER ASSETS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mpmbr351$.jsp" method="get" name="form351">
 	...
 	<tr>
 	<form action="mpmbr351Customise.jsp" method="post">
	...
	//for(int i=1;i<cn;i++) 
    	//{
			...
			ResultSet rsa=st2a.executeQuery("SELECT * FROM MPMBR351Data where S_NO <> 'T_99999' and ITEMCODE ='"+code+"'");
		...
		ResultSet rs=st2.executeQuery("select * from mpmbr351Data where S_NO='T_99999' and ITEMCODE ='"+code+"'");
		while(rs.next())
		{
