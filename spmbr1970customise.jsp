...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("spmbr1970del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from spmbr1970");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into spmbr1970 values(?,?,?,?,?,?,?)");		
