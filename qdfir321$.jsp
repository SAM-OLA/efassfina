...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir321");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 321</title>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">QDFIR 321 - SCHEDULE OF BALANCES HELD WITH OTHER DFI'S / FINANCIAL INSTITUTIONS</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="qdfir321$.jsp" method="post" name="form321">
 	...
 	<tr>
 	<form action="qdfir321Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">TYPE OF BALANCE</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR321.S_NO, QDFIR321.INSTITUTIONCODE, DFI.InstName, QDFIR321.TYPEOFBALANCE, QDFIR321.ACCTNo, QDFIR321.AMOUNT, QDFIR321.REMARKS FROM DFI INNER JOIN QDFIR321 ON DFI.InstCode = QDFIR321.INSTITUTIONCODE where S_NO='"+i+"'");
			Statement stBanks =cnn.createStatement();
			ResultSet rsBanks = stBanks.executeQuery("select * from DFI order by InstName");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir321 where S_NO='T_99999'");
		while(rs.next())
		{
