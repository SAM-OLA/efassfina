...
<BR>
    ...
    <form method="POST" action="generate_mtr.jsp">
    ...
    <input type="hidden" name="mt217" value="0">
    ...
    <input type="hidden" name="mt319" value="0">
      ...
      <tr>
		...
		<tr>
            <td valign="top" align="center" bgcolor="#FFFFE8"><font face="Tahoma">
              <input type="checkbox" name="m217" value="ON" onClick="if (this.checked) {this.form.mt217.value='1';} else {this.form.mt217.value='0';}">
            </font></td>
            <td valign="top" bgcolor="#FFFFE8"><font face="Tahoma" size="2">MTR 217 - CUSTOMERS INFORMATION</font></td>
          </tr>
