...
<%
	...
	//if(flag==true)
	//{
	//	response.sendRedirect("crms100del.jsp");
	//}
	...
	try
	{
		...
		cnt = cnt+1;
		//PreparedStatement pss1=cnn.prepareStatement("Select * from crms100");
		...
		//	String count=request.getParameter("count"+i);
			...
			PreparedStatement pss=cnn.prepareStatement("insert into crms100 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
			pss.setString(1,""+cnt);
			pss.setString(2,f1);
			pss.setString(3,f2);
			pss.setString(4,f3);
