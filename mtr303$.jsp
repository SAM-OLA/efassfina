...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="1154">
  <tr>
    ...
    <td width="1063">
<p align="center"><b><font color="#336699" size="2">MTR 303 - MONTHLY RETURN OF CAPITAL IMPORTATION</font></b></p>     
    </td>
    <td width="18">&nbsp;</td>
  </tr>
</table>
<br>
    ...
    <tr>
        <form action="mtr303$.jsp" method="post" name="form303">
	...
	<td align="center" valign="bottom"><b><font color="#336699" size="2">NATURE OF BUISNESS</font></b></td>
    ...
    <%
    	...
    	{
				Statement stCountryCodes =cnn.createStatement();
				ResultSet rsCountryCodes = stCountryCodes.executeQuery("select Code, Description from CountryCodes");
				Statement stStateCodes =cnn.createStatement();
				ResultSet rsStateCodes = stStateCodes.executeQuery("select * from StateCodes");
				Statement stNatureOfBusinessCodes =cnn.createStatement();
				ResultSet rsNatureOfBusinessCodes = stNatureOfBusinessCodes.executeQuery("select * from NatureOfBusinessCodes");
	...
	String ss4="01-01-1900";
		...
		out.println("<td ><input type=\"text\" name=\"total14\" value="+ss4+"></td >");
		out.println("</tr>");
		out.println("</table>");
