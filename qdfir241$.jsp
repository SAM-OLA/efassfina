...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select * from qdfir241");
		while(rs.next())
		{
			cn++;
		}
...
<title>Cube CBN EFASS System - QDFIR 241</title>
...
<br>
    ...
    <tr>
        <form action="qdfir241$.jsp" method="post" name="form241">
 	...
 	<tr>
 	<form action="qdfir241Customise.jsp" method="post">
	...
	<td align="center"><b><font color="#336699" size="2">FOREIGN CURRENCY</font></b></td>
	<td align="center"><b><font color="#336699" size="2">RATE OF EXCHANGE</font></b></td>
    ...
    <%
    	...
    	for(int i=1;i<cn;i++) 
    	{
			...
			ResultSet rs=st2.executeQuery("SELECT QDFIR241.S_NO, QDFIR241.INSTITUTIONCODE, Banks.BankName, QDFIR241.ACCTNo, QDFIR241.FOREIGNCURRENCY, QDFIR241.RATEOFEXCHANGE, QDFIR241.AMOUNT FROM Banks INNER JOIN QDFIR241 ON Banks.BankCode = QDFIR241.INSTITUTIONCODE where S_NO='"+i+"'");
    	...
    	for(int i=cn;i<ccn;i++) 
    	{
	    	...
	    	String ss1="";
    		Statement st2=cnn.createStatement();
		ResultSet rs=st2.executeQuery("select * from qdfir241 where S_NO='T_99999'");
		while(rs.next())
		{
