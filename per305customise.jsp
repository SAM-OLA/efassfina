...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("per305del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from per305");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into per305 values(?,?,?,?,?,?,?,?)");		
