...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("mtr301del.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from mtr301");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into mtr301 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
		...
		pss.setString(12,String.valueOf(anom));
