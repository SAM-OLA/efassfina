...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("spmbr1910Cdel.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from spmbr1910C");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into spmbr1910C values(?,?,?,?,?,?,?)");		
...
%>
		  <SCRIPT Language = "JavaScript">
		    ...
		    window.location = 'spmbr1910C.jsp';
    		</SCRIPT>
<%
	}
	catch(Exception e)
