...
<%
	...
	if(flag==true)
	{
		response.sendRedirect("spmbr1910Bdel.jsp");
	}
	...
	try
	{
		...
		PreparedStatement pss=cnn.prepareStatement("delete from spmbr1910B");
		pss.executeUpdate();
		for(int ii=1;ii<=cnt;ii++)
		{
			...
			pss=cnn.prepareStatement("insert into spmbr1910B values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");		
...
%>
		  <SCRIPT Language = "JavaScript">
		    ...
		    window.location = 'spmbr1910B.jsp';
    		</SCRIPT>
<%
	}
	catch(Exception e)
